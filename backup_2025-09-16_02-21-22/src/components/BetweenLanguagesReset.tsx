...
import { X, Play, Pause, ChevronRight, Check } from 'lucide-react';
...
export const BetweenLanguagesReset: React.FC<BetweenLanguagesResetProps> = ({ onClose, onComplete }) => {
  // Core states
  ...
  const handleSubmit = () => {
    ...
    if (savePreferences) {
      localStorage.setItem('betweenLanguagesResetPrefs', JSON.stringify({
    ...
    if (trackPatterns) {
      const sessions = JSON.parse(localStorage.getItem('betweenLanguagesSessions') || '[]');
      sessions.push(data);
      localStorage.setItem('betweenLanguagesSessions', JSON.stringify(sessions));
    }
          ...
          <div className="p-8">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  { id: '10s' as ResetDuration, label: '10 seconds', desc: 'Quick switch' },
                  { id: '30s' as ResetDuration, label: '30 seconds', desc: 'Standard reset' },
                  { id: '3m' as ResetDuration, label: '3 minutes', desc: 'Complete clear' },
                  { id: '5m' as ResetDuration, label: '5 minutes', desc: 'Deep restoration' }
                ].map(duration => (
                  <button
                    key={duration.id}
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-4">Find what helps you transition</p>
            ...
            <div className="mb-8 p-6 bg-gradient-to-r from-purple-100 to-blue-100 rounded-2xl">
              ...
              <p className="text-gray-700">
                Your brain's language centers (Broca's and Wernicke's areas) stay activated after interpreting. 
                This reset reduces cross-language interference, helping you start fresh.
              </p>
            </div>
            ...
            <div className="mb-8 space-y-4">
              <div className="bg-white/70 rounded-2xl p-5">
                <h3 className="font-semibold text-gray-800 mb-3">Quick 10-Second Version:</h3>
              ...
              <div className="bg-white/70 rounded-2xl p-5">
                <h3 className="font-semibold text-gray-800 mb-3">30-Second Version:</h3>
                <ul className="space-y-1 text-gray-600">
              ...
              <div className="bg-white/70 rounded-2xl p-5">
                <h3 className="font-semibold text-gray-800 mb-3">3-Minute Full Reset:</h3>
                <ul className="space-y-1 text-gray-600">
            ...
            <div className="mb-8 p-5 bg-amber-50 rounded-2xl">
              <h3 className="font-semibold mb-3 text-amber-900">Adapt As Needed:</h3>
          ...
          <div className="p-8">
            ...
            <div className="mb-8 p-6 bg-white/70 rounded-2xl">
              ...
              <div className="grid grid-cols-2 gap-3">
                {resetOptions.map((option, index) => (
                  <div key={index} className="p-3 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative w-48">
                    <input
                      ...
                      onChange={(e) => setLanguageSeparation(parseInt(e.target.value))}
                      className="w-full"
                    />
                    <div 
                      className="absolute top-1/2 -translate-y-1/2 w-3 h-3 bg-purple-600 rounded-full pointer-events-none"
          ...
          <div className="mb-8 space-y-3">
            ...
            <label className="flex items-center">
              <input
                ...
                className="mr-3"
              />
              <span className="text-gray-700">Set reminder between assignments</span>
            </label>
          </div>
