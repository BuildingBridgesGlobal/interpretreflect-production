      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="rounded-3xl max-w-2xl w-full bg-white">
          <div className="p-8">
            ...
            {/* Reset Options */}
            <div className="mb-6">
              <p className="text-sm font-medium mb-3 text-gray-700">Pick what helps:</p>
              <div className="space-y-3">
                ...
                <div className="p-3 bg-amber-50 rounded-xl">
                  ...
                  <p className="text-sm text-gray-600">Put that assignment away</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-xl">
              <p className="text-sm text-gray-700">
                <strong>Quick tip:</strong> Your brain holds onto the last language you interpreted. 
                Taking even 10 seconds to reset helps your accuracy.
              </p>
            </div>

            {/* Modality tips */}
            <div className="mb-6 text-sm text-gray-600">
              <p><strong>For signing?</strong> Rest your hands and shoulders</p>
              <p><strong>For speaking?</strong> Rest your voice and jaw</p>
            </div>
        ...
        <div className="rounded-3xl max-w-lg w-full bg-white">
          <div className="p-8">
            ...
            <p className="text-gray-600 mb-8 text-center">
              {getDurationSeconds() === 10 ? '10 seconds' : 
               getDurationSeconds() === 30 ? '30 seconds' :
               getDurationSeconds() === 180 ? '3 minutes' : '5 minutes'} to clear
            </p>
      ...
      <div className="rounded-3xl max-w-lg w-full bg-white">
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-2">
              {['Perfect as is', 'Need more time', 'Try different approach'].map(option => (
                <label key={option} className="flex items-center">
                  <input
                    type="radio"
                    name="adjust"
