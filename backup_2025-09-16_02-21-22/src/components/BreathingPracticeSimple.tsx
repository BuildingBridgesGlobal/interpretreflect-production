...
export const BreathingPractice: React.FC<BreathingPracticeProps> = ({ onClose, onComplete }) => {
  const [phase, setPhase] = useState<'setup' | 'practice' | 'pace-change' | 'reflection'>('setup');
  ...
  useEffect(() => {
    if (isPlaying && phase === 'practice') {
      ...
      const phases: Array<{ phase: 'in' | 'hold' | 'out' | 'rest'; duration: number }> = [
        { phase: 'in', duration: timing.in },
        ...(timing.hold > 0 ? [{ phase: 'hold' as const, duration: timing.hold }] : []),
        { phase: 'out', duration: timing.out },
        ...(timing.rest > 0 ? [{ phase: 'rest' as const, duration: timing.rest }] : [])
      ];
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="rounded-3xl max-w-2xl w-full bg-white">
          <div className="p-8">
            ...
            {/* Pace selection */}
            <div className="mb-6">
              <p className="text-sm font-medium mb-3 text-gray-700">Choose your pace:</p>
              <div className="space-y-3">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">Steady, even breathing</p>
                </button>
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">Your own comfortable speed</p>
                </button>
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-xl">
              <p className="text-sm text-gray-700">
                <strong>Tip:</strong> Longer exhales calm your nervous system. But any steady breathing helps.
              </p>
            </div>
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="rounded-3xl max-w-lg w-full bg-white">
          <div className="p-8">
            <h2 className="text-xl font-bold mb-6 text-gray-900">Pick what feels better:</h2>
            ...
            <div className="space-y-3 mb-8">
              {[
                ...
                { value: 'natural' as BreathingPace, label: 'Just in and out (no pauses)' }
              ].map(option => (
                <label key={option.value} className="flex items-center">
                  <input
                    ...
                    onChange={(e) => setSelectedPace(e.target.value as BreathingPace)}
                    className="mr-3"
                  />
  ...
  if (phase === 'practice') {
    ...
    const durationDisplay = getDurationSeconds() === 30 ? '30 seconds' :
                           ...
                           getDurationSeconds() === 120 ? '2 minutes' : '4 minutes';
        ...
        <div className="rounded-3xl max-w-lg w-full bg-white">
          <div className="p-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold text-gray-900">Let's Breathe Together</h2>
              <button onClick={onClose} className="p-2 hover:bg-gray-100 rounded-xl">
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-indigo-600 font-medium">You're doing beautifully.</p>
            </div>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="rounded-3xl max-w-lg w-full bg-white">
        <div className="p-8">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-gray-900">How do you feel?</h2>
            <button onClick={onClose} className="p-2 hover:bg-gray-100 rounded-xl">
              <X className="w-6 h-6" />
            </button>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              {['Just right', 'Too slow', 'Too fast', 'Prefer no counting'].map(option => (
                <label key={option} className="flex items-center">
                  <input
                    type="radio"
                    name="pace"
          ...
          <div className="mb-8">
            ...
            <div className="space-y-2">
              {['Same is perfect', 'Try shorter', 'Try longer'].map(option => (
                <label key={option} className="flex items-center">
                  <input
                    type="radio"
                    name="next"
