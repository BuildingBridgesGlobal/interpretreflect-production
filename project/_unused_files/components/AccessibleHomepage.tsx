...
export const AccessibleHomepage: React.FC<AccessibleHomepageProps> = ({
	...
	const [showAffirmationStudio, setShowAffirmationStudio] =
	...
	const getButtonStyle = (variant: "primary" | "secondary" | "ghost") => {
		const baseStyle =
			"px-4 py-3 rounded-xl font-medium transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 min-h-[44px] min-w-[44px]"; // WCAG: Minimum touch target size
	...
	return (
		<>
			...
			>
				...
				<nav className="px-8 mb-8" aria-label="Reflection tools navigation">
