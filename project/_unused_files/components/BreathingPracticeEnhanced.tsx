import { Heart, Pause, Play, RotateCcw, Sparkles, X } from "lucide-react";
...
const breathingTechniques: Technique[] = [
	{
		...
		name: "Box Breathing",
		description:
			"Equal inhale, hold, exhale, and rest periods create a calming rhythm.",
		benefits:
			"Research shows this technique activates the parasympathetic nervous system, reducing stress hormones and improving focus. Studies from the Journal of Alternative and Complementary Medicine indicate it can lower cortisol levels by up to 20%.",
		steps: [
		...
		researchNote:
			"Supported by research from the American Journal of Physiology",
	},
	{
		id: "physiological-sigh",
		name: "Physiological Sigh",
		description:
			"A natural stress-relief mechanism that resets your breathing pattern.",
		benefits:
			"This technique, discovered by Stanford researchers, can reduce anxiety by up to 90% in just 1 minute. It works by rapidly exhaling carbon dioxide, triggering the vagus nerve to calm the nervous system.",
		steps: [
		...
		researchNote:
			"Stanford University research published in Cell Reports Medicine",
	},
	{
		id: "4-7-8-breathing",
		name: "4-7-8 Breathing",
		description:
			"A relaxation technique that promotes sleep and reduces anxiety.",
		benefits:
			"Developed by Dr. Andrew Weil, this method has been shown to reduce insomnia and anxiety. The extended exhale activates the relaxation response, lowering heart rate and blood pressure.",
		steps: [
...
export const BreathingPracticeEnhanced: React.FC<
	BreathingPracticeEnhancedProps
> = ({ onClose, onComplete, techniques = breathingTechniques }) => {
	...
	const startPractice = () => {
		...
		const stepDuration =
			selectedTechnique.duration / selectedTechnique.steps.length;
