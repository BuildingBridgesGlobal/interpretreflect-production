...
const questions: AssessmentQuestion[] = [
	...
	},
	{
		...
		categoryIcon: <Activity className="h-5 w-5" />,
		question:
			"How would you describe your energy levels after a typical work day?",
		options: [
			{
				value: 0,
				label: "Good",
				description: "Still have energy for personal activities",
			},
			{ value: 1, label: "Manageable", description: "Tired but functional" },
			{
				value: 2,
				label: "Depleted",
				description: "Too exhausted for much else",
			},
			{
				value: 3,
	...
	// Emotional Processing (Questions 4-6)
	{
		...
		question:
			"How do you feel when thinking about upcoming difficult assignments?",
		options: [
			{ value: 0, label: "Prepared", description: "Ready to handle them" },
			{
				value: 1,
				label: "Slightly anxious",
				description: "Some worry but manageable",
			},
			{
				value: 2,
				label: "Very anxious",
				description: "Significant dread or worry",
			},
			{
				value: 3,
				label: "Overwhelmed",
				description: "Want to avoid them entirely",
			},
		],
	},
	{
		...
		categoryIcon: <Heart className="h-5 w-5" />,
		question:
			"After interpreting challenging or emotionally demanding content, how long does it typically stay with you?",
		options: [
			...
			{ value: 2, label: "Weeks", description: "Lingers for a week or more" },
			{
				value: 3,
				label: "Indefinitely",
				description: "Accumulates without release",
			},
		],
	},
	{
		...
		categoryIcon: <Heart className="h-5 w-5" />,
		question:
			"How well can you maintain emotional boundaries during assignments?",
		options: [
			{
				value: 0,
				label: "Very well",
				description: "Clear separation maintained",
			},
			{ value: 1, label: "Usually well", description: "Occasional difficulty" },
			{
				value: 2,
				label: "Struggle often",
				description: "Frequently absorb emotions",
			},
			{
				value: 3,
				label: "Cannot separate",
				description: "Always deeply affected",
			},
		],
	},
	// Professional Impact (Questions 7-9)
	{
		...
		options: [
			{ value: 0, label: "No changes", description: "Performing as usual" },
			{
				value: 1,
				label: "Minor lapses",
				description: "Occasional concentration issues",
			},
			{
				value: 2,
				label: "Frequent issues",
				description: "Regular mistakes or gaps",
			},
			{
				value: 3,
				label: "Major decline",
		...
		options: [
			{
				...
				description: "Strong commitment to growth",
			},
			{
				value: 1,
				label: "Mostly connected",
				description: "Generally satisfied with path",
			},
			{
				value: 2,
				label: "Questioning direction",
				description: "Uncertain about future",
			},
			{
				value: 3,
				label: "Disconnected",
				description: "Considering other paths",
			},
		],
	},
	{
		...
		options: [
			{
				value: 0,
				label: "Very connected",
				description: "Strong sense of meaning",
			},
			{
				value: 1,
				label: "Mostly connected",
				description: "Generally meaningful",
			},
			{ value: 2, label: "Disconnected", description: "Lost sense of purpose" },
			{
				value: 3,
				label: "Completely detached",
				description: "Just going through motions",
			},
		],
	},
	// Recovery Patterns (Questions 10-12)
	{
		...
		question:
			"How long does it take you to recover after a difficult assignment?",
		options: [
			...
			{ value: 1, label: "1-2 days", description: "Need a night's rest" },
			{
				value: 2,
				label: "Several days",
				description: "3-4 days to feel normal",
			},
			{
				value: 3,
				label: "Never fully recover",
				description: "Effects accumulate",
			},
		],
	},
	{
		...
		categoryIcon: <RefreshCw className="h-5 w-5" />,
		question:
			"How consistently do you practice self-care or stress management?",
		options: [
	...
	},
	{
		...
		question:
			"Do you have colleagues or friends who understand your work challenges?",
		options: [
			{
				value: 0,
				label: "Strong support",
				description: "Multiple understanding people",
			},
...
export const BurnoutAssessment: React.FC<AssessmentProps> = ({
	isOpen,
	onClose,
	onComplete,
}) => {
	...
	const calculateResults = async () => {
		...
		const totalScore =
			physicalScore + emotionalScore + professionalScore + recoveryScore;
				...
				<div className="px-6 py-4 border-b" style={{ borderColor: "#E8E5E0" }}>
					<div className="flex items-center justify-between">
						...
						<p className="text-sm mt-2" style={{ color: "#5A5A5A" }}>
							Understanding your unique experience as an interpreter - there are
			...
			<div className="text-center mb-8">
				...
				<div className="mt-6 mb-4">
					<div
						...
						style={{ color: getCategoryColor(results.category) }}
					>
						{results.totalScore}
					</div>
					<div
