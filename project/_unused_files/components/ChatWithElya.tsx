import { Check, Copy, Loader, RefreshCw, Send, User } from "lucide-react";
			...
			>
						...
						{messages.length === 0 ? (
							<div className="flex flex-col items-center justify-center min-h-[60vh] py-20">
								...
								<p
									...
									style={{ color: "#666" }}
								>
									I'm here to support your wellness journey. Share what's on
									your mind, and let's explore it together.
								</p>
							...
							<div className="py-8 space-y-4">
								{messages.map((message) => (
									...
									>
										<div
											className={`group flex gap-3 ${message.sender === "user" ? "flex-row-reverse max-w-[70%]" : "max-w-[70%]"}`}
										>
											{/* Avatar */}
											...
											<div className="space-y-1">
												<div
													className={`flex items-center gap-2 ${message.sender === "user" ? "justify-end" : ""}`}
												>
													<span
				...
				<div
					style={{
						...
						paddingBottom: "24px",
						background:
							"linear-gradient(to top, #FAFAFA 0%, #FAFAFA 75%, rgba(250, 250, 250, 0.9) 90%, rgba(250, 250, 250, 0) 100%)",
						pointerEvents: "none",
					}}
				>
					<div style={{ pointerEvents: "auto" }}>
						...
						>
							...
							<p className="text-xs text-center mt-2" style={{ color: "#999" }}>
								Elya can make mistakes. For emergencies, contact a healthcare
								professional.
							</p>
						</form>
					</div>
