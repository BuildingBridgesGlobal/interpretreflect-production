...
import { type CompassCheckData, supabase } from "../lib/supabase";
...
Completed: ${new Date().toLocaleString()}`;
		...
		<div className="space-y-6">
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("situation_prompt", e.target.value)
					}
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("values_alignment", parseInt(e.target.value))
						}
						className="flex-1"
					/>
		...
		<div className="space-y-6">
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("situation_description", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={3}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("difficulty_factors", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("competing_demands", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
		...
		<div className="space-y-6">
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("challenged_values", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("systemic_factors", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
		...
		<div className="space-y-6">
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("navigation_approach", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("compromises_made", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("hindsight_changes", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("peace_and_troubles", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
		...
		<div className="space-y-6">
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("integrity_effect", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("relationships_affected", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("boundaries_learned", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("role_understanding_change", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
		...
		<div className="space-y-6">
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("alignment_helpers", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("boundaries_to_set", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
	...
	const renderValuesAssessment = () => (
		<div className="space-y-6">
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("integrity_alignment", parseInt(e.target.value))
						}
						className="flex-1"
					/>
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("ethical_clarity", parseInt(e.target.value))
						}
						className="flex-1"
					/>
					<span className="text-sm">10</span>
			...
			<div>
				<label className="block text-sm font-medium text-gray-700 mb-2">
					<AlertCircle className="inline w-4 h-4 mr-1" /> Professional
					Boundaries
				</label>
				<div className="flex items-center space-x-4">
					<span className="text-sm">1</span>
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("personal_peace", parseInt(e.target.value))
						}
						className="flex-1"
					/>
					<span className="text-sm">10</span>
	...
	const renderClosingReflection = () => (
		<div className="space-y-6">
			...
			<div>
				<label className="block text-sm font-medium text-gray-700 mb-2">
					Write a compassionate message to yourself about navigating this
					challenge
				</label>
				<textarea
					value={formData.self_compassion_note}
					onChange={(e) =>
						handleInputChange("self_compassion_note", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={3}
			...
			<div>
				<label className="block text-sm font-medium text-gray-700 mb-2">
					Moving forward, what value will you prioritize and protect more
					carefully?
				</label>
				<textarea
	...
	const renderSection = () => {
		switch (currentSection) {
			...
			case 1:
				return renderTheSituation();
			case 2:
				return renderValuesExploration();
			case 3:
				return renderDecisionProcess();
			case 4:
				return renderImpactConsequences();
			case 5:
				return renderRealignmentIntegration();
			case 6:
				return renderValuesAssessment();
			case 7:
			...
			<div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
				<div className="p-6 border-b border-gray-200">
					...
					<p className="text-gray-600 mb-4">
						When faced with challenging decisions or difficult assignments, it's
						important to realign with your core values. This reflection helps
						you process ethical dilemmas and reconnect with what matters most to
						you.
					</p>
