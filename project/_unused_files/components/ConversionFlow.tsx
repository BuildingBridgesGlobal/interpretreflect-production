...
import { CommunityIcon, HeartPulseIcon, SecureLockIcon } from "./CustomIcon";
...
export function ConversionFlow({ onClose, trigger }: ConversionFlowProps) {
	...
	const socialProof = [
		{
			...
			rating: 5,
			text: "Game-changer for burnout prevention",
		},
		{
			name: "James L.",
			role: "Court Interpreter",
			rating: 5,
			text: "Elya feels like having a therapist on call",
		},
		{
			name: "Maria G.",
			role: "Educational Interpreter",
			rating: 5,
			text: "Perfect 3-minute exercises between assignments",
		},
	];
	...
	const benefits = [
		...
		},
		{
			...
			text: "Join 2,500+ interpreters already using InterpretReflect",
		},
		{
			icon: <Award className="w-5 h-5" />,
			text: "Reduce burnout by 40% in first month",
		},
		{
			icon: <Clock className="w-5 h-5" />,
			text: "Just 3 minutes daily for lasting wellness",
		},
	];
			...
			<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
				<div className="bg-white rounded-2xl p-8 max-w-md w-full text-center">
					...
					<p className="text-gray-600 mb-4">
						We'll send you exclusive wellness tips and early access to new
						features.
					</p>
					<button
						onClick={onClose}
						...
						<>
							...
							<div className="bg-gradient-to-r from-emerald-700 to-blue-700 text-white p-6 rounded-xl text-center">
								<h3 className="text-xl font-bold mb-2">
									Special Offer: 3-Day Free Trial
								</h3>
						...
						<>
							<div className="text-center mb-6">
								...
								<p className="text-gray-600">
									Enter your email to start your free trial and receive
