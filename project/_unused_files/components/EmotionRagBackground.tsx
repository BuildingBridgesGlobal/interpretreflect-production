...
export const emotionThemes = {
	calm: {
		...
		pattern:
			"repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(200, 230, 201, 0.1) 35px, rgba(200, 230, 201, 0.1) 70px)",
		textColor: "#1B5E20",
	...
	anxious: {
		...
		pattern:
			"repeating-linear-gradient(-45deg, transparent, transparent 30px, rgba(255, 224, 178, 0.1) 30px, rgba(255, 224, 178, 0.1) 60px)",
		textColor: "#E65100",
	...
	stressed: {
		...
		pattern:
			"repeating-linear-gradient(90deg, transparent, transparent 40px, rgba(255, 205, 210, 0.1) 40px, rgba(255, 205, 210, 0.1) 80px)",
		textColor: "#C62828",
	...
	energized: {
		...
		pattern:
			"repeating-linear-gradient(120deg, transparent, transparent 25px, rgba(187, 222, 251, 0.1) 25px, rgba(187, 222, 251, 0.1) 50px)",
		textColor: "#0D47A1",
	...
	exhausted: {
		...
		pattern:
			"repeating-linear-gradient(180deg, transparent, transparent 45px, rgba(225, 190, 231, 0.1) 45px, rgba(225, 190, 231, 0.1) 90px)",
		textColor: "#6A1B9A",
		description: "Low energy - time for self-care",
		accessibility:
			"Light purple background indicating exhausted emotional state",
	},
	focused: {
		name: "Focused",
		icon: Wind,
		...
		pattern:
			"repeating-linear-gradient(60deg, transparent, transparent 32px, rgba(178, 223, 219, 0.1) 32px, rgba(178, 223, 219, 0.1) 64px)",
		textColor: "#00695C",
	...
	overwhelmed: {
		...
		pattern:
			"repeating-linear-gradient(135deg, transparent, transparent 38px, rgba(255, 204, 188, 0.1) 38px, rgba(255, 204, 188, 0.1) 76px)",
		textColor: "#D84315",
		description: "Feeling overwhelmed - break needed",
		accessibility:
			"Light coral background indicating overwhelmed emotional state",
	},
	accomplished: {
		name: "Accomplished",
		icon: Sparkles,
		...
		pattern:
			"repeating-linear-gradient(270deg, transparent, transparent 42px, rgba(220, 237, 200, 0.1) 42px, rgba(220, 237, 200, 0.1) 84px)",
		textColor: "#558B2F",
		description: "Feeling accomplished and proud",
		accessibility:
			"Light yellow-green background indicating accomplished emotional state",
	},
	neutral: {
		name: "Neutral",
		icon: Heart,
...
const EmotionRagContext = createContext<EmotionRagContextType | undefined>(
	undefined,
);
...
// Provider component
export function EmotionRagProvider({
	children,
}: {
	children: React.ReactNode;
}) {
	const [currentEmotion, setCurrentEmotionState] =
	...
	return (
		<div
			...
			style={{
				...
				transition:
					animationSpeed !== "none"
						? `background ${animationDuration} ease-in-out`
						: "none",
			}}
			aria-label={
				isEnabled ? theme.accessibility : "Emotion background disabled"
			}
			role="region"
		>
			...
			{/* Emotion Indicator */}
			{showIndicator && isEnabled && <EmotionIndicator theme={theme} />}
...
function EmotionIndicator({
	...
	return (
		...
		>
			...
			>
				<Icon size={20} style={{ color: theme.textColor }} aria-hidden="true" />
					...
					<div>
						<button
							...
							style={{
								...
								alignItems: "center",
								justifyContent: "space-between",
								backgroundColor: patternEnabled
									? theme.secondary
									: "var(--bg-secondary)",
								border: "1px solid var(--border-default)",
								borderRadius: "0.5rem",
