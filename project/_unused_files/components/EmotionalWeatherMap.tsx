		...
		<div className="space-y-6">
			...
			{realTimeAlert && (
				<div
					...
					style={{
						backgroundColor:
							realTimeAlert.type === "warning" ? "#FEF3C7" : "#D1FAE5",
			...
			>
				<div className="flex items-start justify-between mb-6">
					...
					<div className="flex items-center space-x-2">
						<ClimateIcon
							className="h-8 w-8"
							style={{ color: climateStatus.color }}
						/>
			...
			>
				...
				<p className="text-xs" style={{ color: "#6B7280" }}>
					Tracking emotional contagion patterns across {weatherMap.teams.length}{" "}
					teams. This data enables predictive interventions and team wellness
					optimization worth $100K-1M/year.
				</p>
			</div>
		</div>
	);
