					...
					<div className="grid grid-cols-5 gap-4 mt-8">
						...
						<div className="text-center">
							<p className="text-3xl font-bold">
								${(metrics.savedCosts / 1000).toFixed(0)}K
							</p>
							<p className="text-sm opacity-75">Costs Saved</p>
						</div>
						<div className="text-center">
							<p className="text-3xl font-bold">
								${(metrics.emotionalLaborValue / 1000).toFixed(1)}K
							</p>
							<p className="text-sm opacity-75">Labor Value/Year</p>
						</div>
						<div className="text-center">
							<p className="text-3xl font-bold">
								{metrics.cognitiveLoadOptimizations}
							</p>
					...
					{activeFeature === "labor" && (
						...
						>
							...
							>
								...
								<p className="text-sm" style={{ color: "#6B7280" }}>
									First system to quantify surface acting, deep acting, and
									emotional dissonance in real-time, enabling evidence-based
									hazard pay negotiations worth $5-10K per interpreter annually.
								</p>
							</div>
						</div>
					)}
					...
					{activeFeature === "cognitive" && (
						...
						>
							...
							>
								...
								<p className="text-sm" style={{ color: "#6B7280" }}>
									Premium routing charges $500-2000 per assignment based on
									complexity, while preventing cognitive overload and reducing
									errors by 40%.
								</p>
							</div>
						</div>
						...
						>
							<div className="text-center py-12">
								...
								<p style={{ color: "#6B7280" }}>
									Advanced{" "}
									{activeFeature === "trauma" ? "Trauma Response" : "Recovery"}{" "}
					...
					<div className="flex items-center justify-between">
						<div>
							...
							<p className="text-sm mt-1" style={{ color: "#166534" }}>
								From prevented turnover, optimized routing, and justified
								compensation
							</p>
						</div>
