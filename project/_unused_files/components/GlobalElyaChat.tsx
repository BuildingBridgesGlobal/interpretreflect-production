import { Loader, MessageCircle, Mic, Plus, Send, X } from "lucide-react";
						...
						{messages.length === 0 ? (
							<div className="text-center py-8">
								<p className="text-sm" style={{ color: "#666" }}>
									Hi! I'm Elya, your wellness companion. How can I help you
									today?
								</p>
							</div>
						) : (
					...
					>
						...
						>
							...
							<button
								...
								style={{
									background:
										inputMessage.trim() && !isTyping ? "#10B981" : "#F3F4F6",
									borderRadius: "50%",
									width: "48px",
									height: "48px",
									minWidth: "48px",
									...
									border: "1px solid",
									borderColor:
										inputMessage.trim() && !isTyping ? "#10B981" : "#E5E7EB",
									cursor:
							...
							>
								{isTyping ? (
									<Loader
										...
										style={{ color: inputMessage.trim() ? "white" : "#6B7280" }}
									/>
								) : (
									<Send
										size={22}
