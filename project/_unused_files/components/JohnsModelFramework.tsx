...
interface JohnsModelFrameworkProps {
	onClose: () => void;
	onComplete?: () => void;
}

export const JohnsModelFramework: React.FC<JohnsModelFrameworkProps> = ({
	onClose,
	onComplete,
}) => {
	const framework = deepDiveFrameworks.johns;
	...
	const sectionIcons = [
		<FileText className="w-5 h-5" style={{ color: "#6B8B60" }} />,
		...
		<BookOpen className="w-5 h-5" style={{ color: "#6B8B60" }} />,
		<RotateCcw className="w-5 h-5" style={{ color: "#6B8B60" }} />,
	];
