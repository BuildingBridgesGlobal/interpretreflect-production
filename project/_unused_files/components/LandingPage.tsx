							...
							<button
								...
								onMouseEnter={(e) => {
									...
									e.currentTarget.style.boxShadow =
										"0 4px 12px rgba(107, 139, 96, 0.35)";
								}}
								onMouseLeave={(e) => {
									e.currentTarget.style.transform = "translateY(0)";
									e.currentTarget.style.boxShadow =
										"0 2px 8px rgba(107, 139, 96, 0.25)";
								}}
								onFocus={(e) => {
			...
			>
				<div className="absolute inset-0 opacity-10" aria-hidden="true">
					<div
						...
						style={{
							background:
								"radial-gradient(circle, #5C7F4F 0%, transparent 70%)",
					...
					<div
						...
						style={{
							background:
								"radial-gradient(circle, #6B8B60 0%, transparent 70%)",
					...
					<div className="text-center">
						...
						<div className="flex flex-col items-center gap-4 mb-8">
							<div
								...
								style={{
									background:
										"linear-gradient(145deg, #FFD700 0%, #FFC107 100%)",
							...
							>
								...
								<span
									...
									style={{ color: "#4A6B3E" }}
								>
									Built for interpreters, backed by neuroscience, grounded in
									community
								</span>
							</div>
						</div>
						...
						>
							Every session shapes your mind and your career. But the weight you
							carry isn't yours alone.{" "}
							<span className="font-semibold" style={{ color: "#2D5F3F" }}>
								InterpretReflect™ gives you instant support, science-based
								tools, and a sense of belonging, so you can reset, recover, and
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							<button
								...
								onMouseEnter={(e) => {
									...
									e.currentTarget.style.boxShadow =
										"0 8px 25px rgba(107, 139, 96, 0.4)";
								}}
								onMouseLeave={(e) => {
						...
						<p
							className="text-xs"
							style={{ color: "#4A6B3E", fontStyle: "italic" }}
						>
						...
						<div className="mt-12 text-center">
							...
							>
								Spoken, signed, Deaf or hearing, medical to legal, our tools are
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						...
						<div className="text-center">
							...
							<p className="text-sm" style={{ color: "#5A5A5A" }}>
								Take our 2-minute wellness check-in, inspired by the latest
								brain science, and discover your unique patterns and hidden
								strengths. Immediate, personalized insights show you exactly
								where you stand.
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-sm" style={{ color: "#5A5A5A" }}>
								Use rapid, on-the-go techniques, grounded in neuroscience, that
								calm your body and clear your mind, anytime you need it. No
								hour-long meditations needed.
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-sm" style={{ color: "#5A5A5A" }}>
								Track your emotional progress, unlock your best self, and build
								sustainable practices proven to rewire your brain for
								resilience.
							</p>
						</div>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
						...
						>
							...
							<p
								...
								style={{ color: "#5A5A5A", lineHeight: "1.6" }}
							>
								2-minute breathing, body tension, and sensory grounding - built
								for waiting rooms, hallways, and in-between moments.
							</p>
							<ul className="space-y-2">
								<li className="flex items-start">
									<CheckCircle
						...
						>
							...
							<p
								...
								style={{ color: "#5A5A5A", lineHeight: "1.6" }}
							>
								Debrief tough sessions with an AI who 'gets it' - get
								actionable, science-powered tips made for interpreters.
							</p>
							<ul className="space-y-2">
								<li className="flex items-start">
									<CheckCircle
						...
						>
							...
							<p
								...
								style={{ color: "#5A5A5A", lineHeight: "1.6" }}
							>
								Visualize how your brain and resilience adapt. Celebrate every
						...
						<div style={{ display: "none" }}>
							...
							>
								...
								<p
									...
									style={{ color: "#5A5A5A", lineHeight: "1.6" }}
								>
									Connect with interpreters who understand your unique
									challenges
								</p>
								<ul className="space-y-2">
									<li className="flex items-start">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						...
						<p className="text-lg" style={{ color: "#5A5A5A" }}>
							Trusted by healthcare systems, government agencies, and Fortune
							500 companies
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
						...
						<div className="text-center">
							...
							<p className="text-sm" style={{ color: "#5A5A5A" }}>
								Zero-Knowledge Wellness Verification ensures no PHI is ever
								stored or exposed
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-sm" style={{ color: "#5A5A5A" }}>
								Enterprise-grade security controls and audit-ready compliance
								documentation
							</p>
						</div>
						...
						<div className="text-center">
							<div
								...
								style={{
									background:
										"linear-gradient(145deg, #4B79A1 0%, #283E51 100%)",
							...
							<p className="text-sm" style={{ color: "#5A5A5A" }}>
								Full data privacy rights for EU clients with complete
								transparency
							</p>
						</div>
					</div>
					...
					>
						...
						<p className="text-sm" style={{ color: "#5A5A5A" }}>
							Unmatched data protection for healthcare systems and enterprise
							organizations
						</p>
					</div>
				</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						<div className="text-center">
							...
							<p className="text-sm" style={{ color: "#5A5A5A" }}>
								Tools and insights rooted in cutting-edge neuroscience,
								emotional intelligence, and trauma research, customized for your
								unique role.
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-sm" style={{ color: "#5A5A5A" }}>
								All interventions fit into 2-minute breaks, no hidden time
								commitments, no fluff, maximum impact.
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-sm" style={{ color: "#5A5A5A" }}>
								Your journey stays private, always. Data is safe, secure, and
								never shared.
							</p>
						</div>
						...
						<div className="text-center">
							...
							<p className="text-sm" style={{ color: "#5A5A5A" }}>
								Invest in wellness and your future. Professional Plan unlocks
								CEU credits for continuous learning.
							</p>
						</div>
					</div>
				</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
						...
						>
							...
							<h3
								className="text-2xl font-bold mb-2 mt-2"
								style={{ color: "#1A1A1A" }}
							>
					...
					<div className="space-y-4">
						...
						>
							...
							>
								...
								InterpretReflect™ is a wellness support tool, not a substitute
								for professional mental health care. If you are experiencing
								significant distress, please consult a qualified professional.
							</p>
						</div>
					</div>
				</div>
