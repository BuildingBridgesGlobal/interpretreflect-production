			...
			<main id="main-content" role="main">
						...
						<div className="text-center">
							...
							>
								...
								<span
									...
									style={{ color: colors.sage[600] }}
								>
									The only wellness platform built for interpreters, backed by
									neuroscience
								</span>
							</div>
							...
							>
								Unwind Your Mind.
								<br />
								<span style={{ color: colors.sage[600] }}>
							...
							>
								Every session shapes your mind and your career. But the weight
								you carry isn't yours alone. InterpretReflect™ gives you instant
								support, science-based tools, and a sense of belonging, so you
								can reset, recover, and thrive for the long run.
							</p>
							...
							<p className="text-sm mt-4" style={{ color: colors.gray[600] }}>
					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						...
						<div className="grid md:grid-cols-3 gap-12">
							...
							<article className="text-center">
								...
								<p style={{ color: colors.gray[600] }}>
									Use rapid, on-the-go techniques, grounded in neuroscience,
									that calm your body and clear your mind, anytime you need it.
									No hour-long meditations needed.
								</p>
							</article>
							...
							<article className="text-center">
								...
								<p style={{ color: colors.gray[600] }}>
									Track your emotional progress, unlock your best self, and
									build sustainable practices proven to rewire your brain for
									resilience.
								</p>
							</article>
						</div>
						...
						<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
							...
							<article
								...
								style={{
									...
									border: `1px solid ${colors.sage[300]}40`,
								}}
							>
								<div
							...
							>
								...
								<p className="text-sm mb-4" style={{ color: colors.gray[600] }}>
									2-minute breathing, body tension, and sensory grounding -
									built for waiting rooms, hallways, and in-between moments.
								</p>
								<ul className="space-y-2" role="list">
									<li className="flex items-start">
										<CheckCircle
						...
						<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
							<article>
								...
								<p style={{ color: colors.gray[600] }}>
									...
									emotional intelligence, and trauma research, customized for
									your unique role.
								</p>
							</article>
				...
				>
					<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
						...
						<p className="text-lg mb-6" style={{ color: colors.gray[700] }}>
							We are committed to making InterpretReflect™ accessible to all
							users, regardless of ability or circumstance.
						</p>
						...
						<p className="text-sm mt-6" style={{ color: colors.gray[600] }}>
				...
				>
					<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
						...
						<p className="text-xl mb-8" style={{ color: colors.gray[700] }}>
							Your wellbeing is non-negotiable, and you don't have to do it
							alone.
						</p>
						...
						<p className="mt-12 text-base" style={{ color: colors.gray[700] }}>
