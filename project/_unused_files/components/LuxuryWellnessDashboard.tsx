...
export const LuxuryWellnessDashboard: React.FC<
	LuxuryWellnessDashboardProps
> = ({ userName = "Beautiful Soul", onTabChange }) => {
	const { user } = useAuth();
	...
	const getTimeIcon = () => {
		switch (timeOfDay) {
			case "morning":
				return <Sunrise className="w-7 h-7" />;
			case "afternoon":
		...
		>
			...
			<div className="absolute inset-0 pointer-events-none">
				...
				<div
					...
					style={{
						background:
							"radial-gradient(circle, rgba(92, 127, 79, 0.2) 0%, transparent 70%)",
						filter: "blur(40px)",
					}}
				/>
				{/* Gentle sky blue orb */}
				...
				{/* Soft lavender orb */}
				<div
					className="absolute top-1/2 left-1/3 w-72 h-72 rounded-full opacity-12"
					style={{
						background:
				...
				{/* Gentle cream accent */}
				<div
					className="absolute top-1/3 right-1/4 w-64 h-64 rounded-full opacity-8"
					style={{
						background:
							"radial-gradient(circle, rgba(248, 250, 252, 0.4) 0%, transparent 70%)",
						filter: "blur(30px)",
					}}
				/>
				{/* Subtle wellness-inspired shapes */}
				<div
					className="absolute bottom-1/3 left-1/4 w-96 h-48 opacity-4"
					style={{
						background:
							"linear-gradient(90deg, transparent, rgba(92, 127, 79, 0.15), transparent)",
			...
			<div
				id="main-content"
				className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 py-6 md:py-8 pb-24 md:pb-8"
				role="main"
			...
			>
				...
				<header className="mb-6">
					<div className="flex items-center justify-between mb-2">
						<div className="flex items-center gap-3">
							<div style={{ color: "#5C7F4F" }}>{getTimeIcon()}</div>
							<h1
					...
					<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
						<div>
							...
							>
								...
								<p>
									InterpretReflect is your sanctuary for growth, resilience, and
									connection.
								</p>
							</div>
							<p
								...
								style={{ color: "#718096" }}
							>
								Personalized tools. Science-backed reflection. Community
								support.
							</p>
						</div>
						<div className="flex items-center gap-2 mt-2 sm:mt-0">
							...
							<span className="text-xs" style={{ color: "#718096" }}>
								Your space is private and secure
							</span>
						</div>
					</div>
				</header>
				...
				<section className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-16">
					{/* Daily Check-In Card */}
					<div
						className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 transition-all duration-300 hover:shadow-lg hover:bg-white/90 hover:scale-105"
						style={{
						...
						<div className="flex flex-col items-center text-center space-y-6">
							...
							<div className="space-y-3">
								...
								<p
									...
									style={{ color: "#718096" }}
								>
									A gentle pause to tune into your inner self.
								</p>
							</div>
							<button
					...
					>
						<div className="flex flex-col items-center text-center space-y-6">
							<div
								className="w-16 h-16 rounded-full flex items-center justify-center"
								style={{ backgroundColor: "rgba(165, 180, 252, 0.1)" }}
							>
							...
							<div className="space-y-3">
								...
								<p
									...
									style={{ color: "#718096" }}
								>
									Soft prompts for thoughtful self-discovery.
								</p>
							</div>
							<button
						...
						<div className="flex flex-col items-center text-center space-y-6">
							...
							<div className="space-y-3">
								...
								<p
									...
									style={{ color: "#718096" }}
								>
									Simple exercises to restore calm and balance.
								</p>
							</div>
							<button
							...
							<div className="p-4 border-b border-gray-100">
								<div className="text-center">
									...
									<div className="text-xs text-gray-500">
										Personal growth through mindful practice
									</div>
								</div>
							</div>
				...
				<div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50">
					...
					>
						...
						>
							...
							<span
								className="absolute -top-1 -right-1 flex items-center gap-1 px-1.5 py-0.5 text-xs font-semibold rounded-full"
								style={{
					...
					<button
						...
						aria-label={
							fabOpen ? "Close quick access menu" : "Open quick access menu"
						}
					>
