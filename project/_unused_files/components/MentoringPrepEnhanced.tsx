...
import type { MentoringPrepData } from "../lib/supabase";
		...
		switch (sectionIndex) {
			case 0: // Quick Insight
				if (!formData.seeking_reason.trim()) {
					newErrors.seeking_reason =
						"Please explain why you're seeking mentoring";
				}
				break;
			...
			case 2: // Defining Success
				if (!formData.success_definition.trim()) {
					newErrors.success_definition =
						"Please define success for this session";
				}
			...
			case 3: {
				...
				const filledQuestions = formData.top_questions.filter((q) =>
					q.trim(),
				).length;
			...
			case 4: // Openness & Boundaries
				if (!formData.valuable_feedback_type.trim()) {
					newErrors.valuable_feedback_type =
						"Please describe valuable feedback";
				}
				break;
			case 5: // Action Readiness
				if (!formData.ready_to_commit.trim()) {
					newErrors.ready_to_commit =
						"Please describe what you're ready to commit to";
				}
				...
				<div className="space-y-6">
					...
					>
						...
						<p className="mb-6" style={{ color: "#5A5A5A" }}>
							Before your mentoring session, let's clarify your goals, prepare
							your questions, and set intentions for a productive conversation.
							This preparation will maximize the value of your mentoring time.
						</p>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
							<div>
								...
								<select
									...
									onChange={(e) =>
										handleFieldChange("mentoring_type", e.target.value)
									}
								...
								{formData.mentoring_type === "other" && (
									<input
										...
										onChange={(e) =>
											handleFieldChange("mentoring_type_other", e.target.value)
										}
							...
							<div>
								...
								<select
									...
									onChange={(e) =>
										handleFieldChange("meeting_format", e.target.value)
									}
									className="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500"
									style={{ borderColor: "#E5E7EB" }}
								>
						...
						<div>
							...
							<textarea
								...
								onChange={(e) =>
									handleFieldChange("seeking_reason", e.target.value)
								}
				...
				<div className="space-y-6">
					<div>
						<label
							...
							style={{ color: "#7C3AED" }}
						>
							What specific situation or challenge brings you to mentoring
							today?
						</label>
						<textarea
							value={formData.specific_situation}
							onChange={(e) =>
								handleFieldChange("specific_situation", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("context_needed", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("already_tried", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("whats_at_stake", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("urgency_level", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("success_definition", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("success_indicators", e.target.value)
							}
					...
					<div>
						<label
							...
							style={{ color: "#7C3AED" }}
						>
							What type of support would be most helpful? (advice, validation,
							accountability, connections, other)
						</label>
						<textarea
							value={formData.support_type_needed}
							onChange={(e) =>
								handleFieldChange("support_type_needed", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("what_not_wanted", e.target.value)
							}
				...
				<div className="space-y-6">
								...
								<input
									...
									style={{
										borderColor:
											...
											index < 3 &&
											!formData.top_questions[index]?.trim()
												? "#ef4444"
												: "#E5E7EB",
									}}
								/>
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("materials_to_share", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("difficult_topics", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("patterns_to_explore", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("assumptions_to_check", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						<label
							...
							style={{ color: "#7C3AED" }}
						>
							How open are you to feedback that might be difficult to hear?
							(1-10)
						</label>
						<div className="flex items-center space-x-4">
							<input
								...
								onChange={(e) =>
									handleFieldChange("feedback_openness", Number(e.target.value))
								}
								className="flex-1"
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("valuable_feedback_type", e.target.value)
							}
							placeholder="Describe the type of feedback that would help most..."
							rows={3}
							className="w-full px-4 py-3 border rounded-lg resize-none focus:ring-2 focus:ring-purple-500"
							style={{
								borderColor: errors.valuable_feedback_type
									? "#ef4444"
									: "#E5E7EB",
							}}
						/>
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("conversation_boundaries", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("off_limits_topics", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("directness_preference", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("ready_to_commit", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("implementation_resources", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("potential_blockers", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("progress_tracking_plan", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("followup_timeline", e.target.value)
							}
							...
							<div>
								...
								<div className="flex items-center space-x-4">
									<input
										...
										style={{
											accentColor:
												formData.current_stress_level >= 7
													? "#EF4444"
													: "#A855F7",
										}}
									/>
			...
			content: (
				<div className="space-y-6">
					...
					>
						...
						<p className="mb-6" style={{ color: "#5A5A5A" }}>
							Write one clear request you'll make of your mentor and one thing
							you'll offer or share in return.
						</p>
						...
						<div className="space-y-6">
							<div>
								...
								<textarea
									...
									onChange={(e) =>
										handleFieldChange("clear_request", e.target.value)
									}
							...
							<div>
								...
								<textarea
									...
									onChange={(e) =>
										handleFieldChange("offering_in_return", e.target.value)
									}
									placeholder="Describe what you'll contribute to the relationship..."
									rows={3}
									className="w-full px-4 py-3 border rounded-lg resize-none focus:ring-2 focus:ring-purple-500"
									style={{
										borderColor: errors.offering_in_return
											? "#ef4444"
											: "#E5E7EB",
									}}
								/>
					...
					<div className="p-4 rounded-lg bg-purple-50 border border-purple-200">
						<p className="text-sm text-purple-700">
							<strong>Remember:</strong> Share this preparation summary with
							your mentor if appropriate. It will help them understand your
							needs and make the session more productive.
						</p>
					</div>
				</div>
			),
					...
					>
						...
						<div className="mt-6 space-y-3">
							...
							<p className="text-center text-sm text-gray-600">
								Consider sharing this summary with your mentor for a more
								productive session
							</p>
						</div>
					</div>
