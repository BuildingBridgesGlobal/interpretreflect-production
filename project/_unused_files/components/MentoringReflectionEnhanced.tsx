...
import {
	type MentoringPrepData,
	type MentoringReflectionData,
	supabase,
} from "../lib/supabase";
...
export const MentoringReflectionEnhanced: React.FC<
	MentoringReflectionEnhancedProps
> = ({ onComplete, onClose, prepDataId }) => {
	...
	const handleFieldChange = (
		field: keyof MentoringReflectionData,
		value: any,
	) => {
		setFormData((prev) => ({
			...prev,
		...
		switch (sectionIndex) {
			...
			case 1: // Revisiting Intentions
				if (!formData.ask_addressed.trim()) {
					newErrors.ask_addressed =
						"Please reflect on how your ask was addressed";
				}
				break;
			case 2: {
				// Key Insights
				const filledThings = formData.three_important_things.filter((t) =>
					t.trim(),
				).length;
				if (filledThings < 3) {
					newErrors.three_important_things =
						"Please provide three important things";
				}
				break;
			}
			case 3: // Emotional Processing
				if (!formData.emotional_journey.trim()) {
					newErrors.emotional_journey =
						"Please describe your emotional journey";
				}
			...
			case 8: // Closing Commitment
				...
				if (!formData.payforward_commitment.trim()) {
					newErrors.payforward_commitment =
						"Please write how you'll pay it forward";
				}
				break;
		}
	...
	const handleSave = async () => {
		...
		try {
			...
			const finalData = {
				...
				mentoring_insights:
					formData.three_important_things?.[0] ||
					formData.new_perspectives ||
					"Mentoring reflection completed",
			};

			console.log(
				"MentoringReflectionEnhanced - Saving with reflectionService",
			);
				...
				<div className="space-y-6">
					...
					>
						...
						<p className="mb-6" style={{ color: "#5A5A5A" }}>
							Now that you've completed your mentoring session, let's
							consolidate insights, process the feedback, and create an action
						...
						<div className="space-y-6">
							<div>
								...
								<input
									...
									onChange={(e) =>
										handleFieldChange("session_word", e.target.value)
									}
							...
							<div>
								...
								<textarea
									...
									onChange={(e) =>
										handleFieldChange("most_surprising", e.target.value)
									}
				...
				<div className="space-y-6">
							...
							{showPrepData && (
								...
								>
									<div className="space-y-3">
										<div>
											<span className="font-medium">Your Ask:</span>{" "}
											{prepData.specific_situation}
										</div>
										<div>
											<span className="font-medium">Success Criteria:</span>{" "}
											{prepData.success_definition}
										</div>
										<div>
											<span className="font-medium">Your Questions:</span>
											<ul className="ml-4 mt-1">
												{prepData.top_questions
													.filter((q) => q)
													.map((q, i) => (
														<li key={i}>• {q}</li>
													))}
										...
										<div>
											<span className="font-medium">Boundaries Set:</span>{" "}
											{prepData.conversation_boundaries}
										</div>
										<div>
											<span className="font-medium">Your Request:</span>{" "}
											{prepData.clear_request}
										</div>
									</div>
								</div>
							)}
					...
					<div>
						...
						>
							{prepData ? (
								<>
									...
									<strong>{prepData.specific_situation}</strong>". How well was
									this addressed?
								</>
							) : (
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("ask_addressed", e.target.value)
							}
					...
					<div>
						...
						>
							{prepData ? (
								<>
									...
									<strong>{prepData.success_definition}</strong>". Were these
									met?
								</>
							) : (
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("success_criteria_met", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("questions_answered", e.target.value)
							}
					...
					<div>
						...
						>
							{prepData && prepData.conversation_boundaries ? (
								<>
									...
									<strong>{prepData.conversation_boundaries}</strong>". Were
									these respected?
								</>
							) : (
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("boundaries_respected", e.target.value)
							}
				...
				<div className="space-y-6">
						...
						<div className="space-y-3">
							{[0, 1, 2].map((index) => (
								<input
									...
									onChange={(e) =>
										handleImportantThingChange(index, e.target.value)
									}
									...
									style={{
										borderColor:
											...
											!formData.three_important_things[index]?.trim()
												? "#ef4444"
												: "#E5E7EB",
									}}
								/>
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("hard_but_valuable", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("new_perspectives", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("patterns_spotted", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("validation_received", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("emotional_journey", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("current_emotions", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("strongest_reaction", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("needs_processing", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("specific_next_steps", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("next_48_hours", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("application_plan", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("potential_obstacles", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("accountability_plan", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("mentor_checkin", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("progress_measurement", e.target.value)
							}
							...
							<div>
								...
								<div className="flex items-center space-x-4">
									<input
										...
										onChange={(e) =>
											handleFieldChange("clarity_level", Number(e.target.value))
										}
										className="flex-1"
										style={{ accentColor: "#A855F7" }}
									/>
							...
							<div>
								...
								{prepData && (
									<p className="text-sm text-gray-600 mt-1">
										...
										{prepData.needs_articulation_confidence}/10 → Post:{" "}
										{formData.confidence_forward}/10
									</p>
								)}
							</div>
				...
				<div className="space-y-6">
						...
						>
							...
							<div className="grid grid-cols-2 gap-4 text-sm">
								<div>
									...
									{prepData.needs_articulation_confidence}/10 →{" "}
									{formData.confidence_forward}/10
								</div>
								<div>
									<span className="font-medium">Stress:</span>{" "}
									{prepData.current_stress_level}/10 → Current state
								</div>
								<div>
									<span className="font-medium">Openness:</span>{" "}
									{prepData.openness_to_perspectives}
									/10
								</div>
								<div>
									<span className="font-medium">Feedback readiness:</span>{" "}
									{prepData.feedback_openness}/10
								</div>
							</div>
						</div>
					)}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("stress_comparison", e.target.value)
							}
					...
					<div>
						...
						>
							{prepData ? (
								<>
									Your openness to feedback was {prepData.feedback_openness}/10.
									How did you actually receive feedback?
								</>
							) : (
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("feedback_reception", e.target.value)
							}
			...
			content: (
				<div className="space-y-6">
					...
					>
						...
						<p className="mb-6" style={{ color: "#5A5A5A" }}>
							Based on this mentoring session, write three specific commitments:
							one action you'll take, one mindset you'll adopt, and one way
						...
						<div className="space-y-6">
							<div>
								...
								<textarea
									...
									onChange={(e) =>
										handleFieldChange("action_commitment", e.target.value)
									}
									placeholder="Write a specific, measurable action..."
									rows={3}
									className="w-full px-4 py-3 border rounded-lg resize-none focus:ring-2 focus:ring-purple-500"
									style={{
										borderColor: errors.action_commitment
											? "#ef4444"
											: "#E5E7EB",
									}}
								/>
							...
							<div>
								...
								<textarea
									...
									onChange={(e) =>
										handleFieldChange("mindset_commitment", e.target.value)
									}
									placeholder="Describe a new perspective or attitude..."
									rows={3}
									className="w-full px-4 py-3 border rounded-lg resize-none focus:ring-2 focus:ring-purple-500"
									style={{
										borderColor: errors.mindset_commitment
											? "#ef4444"
											: "#E5E7EB",
									}}
								/>
							...
							<div>
								...
								<textarea
									...
									onChange={(e) =>
										handleFieldChange("payforward_commitment", e.target.value)
									}
									placeholder="How will you help or mentor others..."
									rows={3}
									className="w-full px-4 py-3 border rounded-lg resize-none focus:ring-2 focus:ring-purple-500"
									style={{
										borderColor: errors.payforward_commitment
											? "#ef4444"
											: "#E5E7EB",
									}}
								/>
					...
					<div className="p-4 rounded-lg bg-purple-50 border border-purple-200">
						<p className="text-sm text-purple-700">
							<strong>Remember:</strong> Follow up with your mentor as planned.
							Your growth is a journey, and this session is just one important
							step along the way.
						</p>
					</div>
				</div>
						...
						<div className="flex space-x-2">
							{sections.map((_, index) => (
								<div
									...
									style={{
										backgroundColor:
											index <= currentSection ? "#A855F7" : "#E5E7EB",
										minWidth: "30px",
									}}
								/>
							))}
