...
export const ModernHomepage: React.FC<ModernHomepageProps> = ({
	...
	const testimonials = [
		{
			quote:
				"InterpretReflect helped me recognize burnout patterns I didn't even know I had. The daily check-ins are a game-changer.",
			author: "Sarah M.",
		...
		{
			quote:
				"Finally, a wellness platform that understands the unique challenges interpreters face. It's like having a mentor in my pocket.",
			author: "James L.",
		...
		{
			quote:
				"The reflection tools and AI coach have transformed how I process difficult assignments. I feel more resilient than ever.",
			author: "Maria G.",
						...
						<div>
							...
							<div className="inline-flex items-center gap-2 bg-green-100 text-green-800 px-4 py-2 rounded-full mb-6">
								...
								<span className="text-sm font-medium">
									Trusted by 10,000+ Interpreters Worldwide
								</span>
							</div>
							...
							<p className="text-xl text-gray-600 mb-8 leading-relaxed">
								The first wellness platform designed specifically for
								interpreters. Prevent burnout, process emotions, and thrive in
								your profession.
							</p>
						...
						{[
							{
								...
								description:
									"Quick 2-minute daily check-in to understand your wellness patterns",
								icon: BarChart3,
							...
							},
							{
								...
								description:
									"AI-powered recommendations based on your unique interpreter challenges",
								icon: Brain,
							...
							},
							{
								...
								description:
									"Access targeted exercises, reflections, and connect with peers",
								icon: Heart,
							...
							<div key={index} className="relative">
								...
								<div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
									<div
										className={`inline-flex items-center justify-center w-16 h-16 rounded-full ${item.color} mb-6`}
									>
			...
			<section className="py-20 bg-gradient-to-b from-gray-50 to-white">
				<div className="max-w-7xl mx-auto px-6">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-600 max-w-2xl mx-auto">
							Comprehensive wellness tools designed for your unique professional
							challenges
						</p>
					</div>
						...
						{[
							...
							<div
								...
								className={`relative bg-white rounded-2xl p-8 ${
									plan.popular
										? "shadow-2xl scale-105 border-2 border-green-600"
			...
			<section className="py-20 bg-gradient-to-r from-green-600 to-teal-600">
				<div className="max-w-4xl mx-auto px-6 text-center">
					...
					<p className="text-xl text-green-100 mb-8">
						Join thousands of interpreters who've taken control of their
						well-being
					</p>
