...
const PostAssignmentDebrief: React.FC<PostAssignmentDebriefProps> = ({
	onComplete,
	onClose,
}) => {
	const { user } = useAuth();
	...
	const toggleEmotion = (
		emotion: string,
		category: "client" | "professional" | "personal",
	) => {
		if (category === "client") {
					...
					<div className="space-y-6">
						<div className="text-center mb-8">
							...
							<p className="text-sm" style={{ color: "#6B7C6B" }}>
								Based on Somatic Experiencing (Levine, 1997) & Polyvagal Theory
								(Porges, 2011)
							</p>
						</div>
								...
								<div className="flex items-start mb-4">
									...
									<div className="flex-1">
										...
										<p className="text-sm mb-3" style={{ color: "#3A3A3A" }}>
											Literally shake hands, arms, shoulders. Jump in place if
											possible.
										</p>
										...
										<div className="mt-3 p-3 rounded-lg bg-white/50">
											<p className="text-xs" style={{ color: "#6B7C6B" }}>
												<strong>Science:</strong> Discharges trapped stress
												hormones (Berceli, 2005)
											</p>
										</div>
									</div>
								</div>
							...
							<div className="p-6 rounded-xl bg-gradient-to-r from-blue-50 to-cyan-50">
								<div className="flex items-start mb-4">
									...
									<div className="flex-1">
										...
										<div className="mt-3 p-3 rounded-lg bg-white/50">
											<p className="text-xs" style={{ color: "#6B7C6B" }}>
												<strong>Science:</strong> Fastest way to calm nervous
												system (Huberman Lab, 2023)
											</p>
										</div>
									</div>
								</div>
							...
							<div className="p-6 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50">
								<div className="flex items-start mb-4">
									...
									<div className="flex-1">
										...
										<p className="text-sm mb-3" style={{ color: "#3A3A3A" }}>
											Open mouth wide, move jaw side to side. Roll shoulders
											backward 5 times.
										</p>
										...
										<div className="mt-3 p-3 rounded-lg bg-white/50">
											<p className="text-xs" style={{ color: "#6B7C6B" }}>
												<strong>Science:</strong> Releases tension from
												concentrated listening (Gawler & Leach, 2019)
											</p>
										</div>
									</div>
								</div>
						...
						<div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6">
							...
							>
								<p className="text-sm" style={{ color: "#2D5F3F" }}>
									<strong>Impact:</strong> 90 seconds of expressive writing
									reduces cortisol by 23% and improves sleep quality by 29%
				...
				return (
					<div className="space-y-6">
						...
						<div className="space-y-6">
							...
							>
								<p className="text-sm" style={{ color: "#2D5F3F" }}>
									<strong>Science:</strong> Naming emotions with precision
									reduces their intensity by 50% (Lieberman et al., 2007)
								</p>
							</div>
						</div>
					</div>
						...
						<div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6">
							...
							>
								<p className="text-sm" style={{ color: "#1E40AF" }}>
									<strong>Impact:</strong> Writing learning points within 5
									minutes increases retention by 42% (Karpicke & Blunt, 2011)
								</p>
							</div>
						</div>
					</div>
							...
							<div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6">
									...
									<div className="flex items-start mb-4">
										...
										<div>
											...
											<p className="text-sm mb-4" style={{ color: "#3A3A3A" }}>
												Push palms away from chest (literally pushing away the
												session)
											</p>
										...
										<div className="flex-1">
											...
											>
												<p className="italic" style={{ color: "#2D5F3F" }}>
													"I provided professional service with skill and
													integrity. This assignment is complete. I release what
								...
								{!boundaryComplete && (
									<button
										...
										style={{
											background:
												"linear-gradient(145deg, #5C7F4F 0%, #8FA080 100%)",
											color: "#FFFFFF",
										}}
									>
										Complete Ritual
								...
								{redFlags.length > 0 && (
									<div className="mt-4 p-3 rounded-lg bg-red-100">
										<p
											...
											style={{ color: "#991B1B" }}
										>
											⚠️ Consider reaching out to a supervisor or mental health
											professional
										</p>
									</div>
								)}
									...
									{stressLevelAfter < stressLevelBefore ? (
										<>
											...
											<span
												...
												style={{ color: "#059669" }}
											>
												Stress reduced by {stressLevelBefore - stressLevelAfter}{" "}
												levels!
											</span>
										</>
									) : (
