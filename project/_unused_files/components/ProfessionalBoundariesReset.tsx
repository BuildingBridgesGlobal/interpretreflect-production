import { AlertCircle, Heart, Pause, Play, X } from "lucide-react";
...
> = ({ onClose, onComplete }) => {
	...
	const [phase, setPhase] = useState<
		"setup" | "practice" | "reflection" | "support"
	>("setup");
	...
	const [currentMessage, setCurrentMessage] = useState(
		"What you interpreted matters, and so do you",
	);
	...
	const stepByStepPath = [
		{
			...
			title: "Anchor",
			time: "10 seconds",
			action: "Connect with something solid near you",
		},
		{
			step: 2,
			title: "Clarify",
			time: "20 seconds",
			action: '"I facilitated communication professionally"',
		},
		{
			step: 3,
			title: "Ground",
			time: "30 seconds",
			action: "Return to your surroundings",
		},
		{
			step: 4,
			title: "Acknowledge",
			time: "20 seconds",
			action: '"I served with skill and boundaries"',
		},
		{
			step: 5,
			title: "Complete",
			time: "10 seconds",
			action: "Take three settling breaths",
		},
	];
	...
	const handleSubmit = () => {
		...
		if (logReset) {
			const sessions = JSON.parse(
				localStorage.getItem("boundariesSessions") || "[]",
			);
			sessions.push(data);
					...
					<div className="p-8">
						...
						<div className="mb-8">
							...
							<div className="grid grid-cols-2 md:grid-cols-4 gap-3">
								{[
									...
									{
										id: "90s" as ResetDuration,
										label: "90 seconds",
										desc: "Standard process",
									},
									{
						...
						<div className="mb-8 p-6 bg-gradient-to-r from-rose-100 to-orange-100 rounded-2xl">
							...
							<p className="text-gray-700">
								Intense content activates your mirror neurons as if you're
								experiencing it yourself. This reset helps your prefrontal
								cortex restore professional boundaries.
							</p>
						</div>
						...
						<div className="mb-8 bg-amber-50 rounded-2xl p-5">
							...
							<ul className="space-y-2 text-sm text-amber-800">
								<li>
									• <strong>Private space:</strong> Use full process with voice
								</li>
								<li>
									• <strong>Team setting:</strong> Silent internal process
								</li>
								<li>
									• <strong>Public space:</strong> Brief, subtle version
								</li>
								<li>
									• <strong>Remote/VRI:</strong> Step away from screen if
									possible
								</li>
							</ul>
						</div>
						...
						<div className="mb-8">
							...
							<div className="flex gap-1">
								{[...Array(10)].map((_, i) => (
									<div
										key={i}
										className={`h-2 w-full rounded-full ${i === 3 ? "bg-rose-500" : "bg-gray-300"}`}
									/>
								))}
							</div>
						</div>
						...
						<div className="mb-8 p-6 bg-white/70 rounded-2xl">
							...
							<div className="grid grid-cols-2 gap-3">
								{resetOptions.slice(0, 4).map((option, index) => (
									<div
										key={index}
										className="p-3 bg-gradient-to-r from-rose-50 to-orange-50 rounded-xl"
									>
							...
							<div className="grid md:grid-cols-2 gap-4">
								<button className="p-5 bg-white rounded-2xl text-left hover:shadow-lg transition-all">
									<h4 className="font-semibold text-gray-800 mb-2">
										Extended reset practice
									</h4>
									<p className="text-sm text-gray-600 mb-3">
										Take 5 more minutes to fully reset
									</p>
								...
								<button className="p-5 bg-white rounded-2xl text-left hover:shadow-lg transition-all">
									...
									<p className="text-sm text-gray-600 mb-3">
										Connect with a colleague who understands
									</p>
							...
							<div className="grid md:grid-cols-2 gap-4">
								<div className="p-5 bg-amber-50 rounded-2xl">
									<h4 className="font-medium text-amber-900 mb-2">
										Schedule debrief session
									</h4>
									<p className="text-sm text-amber-800">
										Process today's content with support
									</p>
								</div>

								<div className="p-5 bg-amber-50 rounded-2xl">
									<h4 className="font-medium text-amber-900 mb-2">
										Professional development on boundaries
									</h4>
									<p className="text-sm text-amber-800">
										Strengthen your boundary-setting skills
									</p>
								</div>
								...
								<div className="p-5 bg-amber-50 rounded-2xl">
									...
									<p className="text-sm text-amber-800">
										Join others who understand these challenges
									</p>
								</div>
								...
								<div className="p-5 bg-amber-50 rounded-2xl">
									...
									<p className="text-sm text-amber-800">
										Access self-care tools and strategies
									</p>
								</div>
							</div>
						</div>
						...
						<div className="mb-8 p-6 bg-gradient-to-r from-rose-100 to-orange-100 rounded-2xl">
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="text-gray-700">
										Seeking support is professional wisdom, not personal
										weakness. Your wellbeing directly impacts your ability to
				...
				<div className="p-8">
								...
								<div className="flex items-center gap-3">
									...
									<div className="relative w-48">
										<input
											...
											onChange={(e) =>
												setEmotionalDistance(parseInt(e.target.value))
											}
											className="w-full"
										/>
										<div
								...
								<div className="flex items-center gap-3">
									...
									<div className="relative w-48">
										<input
											...
											onChange={(e) =>
												setProfessionalClarity(parseInt(e.target.value))
											}
											className="w-full"
										/>
										<div
					...
					<div className="mb-6">
						...
						<div className="space-y-2">
							{[
								{
									value: "ready" as SupportNeed,
									label: "I'm ready to continue",
								},
								{
									value: "longer-break" as SupportNeed,
									label: "Need a longer break",
								},
								{
									value: "peer-support" as SupportNeed,
									label: "Would like peer support",
								},
								{
									value: "supervision" as SupportNeed,
									label: "Considering supervision",
								},
								{
									value: "end-day" as SupportNeed,
									label: "Ready to end my day",
								},
							].map((option) => (
								<label key={option.value} className="flex items-center">
									<input
										...
										onChange={(e) =>
											setSupportNeed(e.target.value as SupportNeed)
										}
										className="mr-3"
									/>
						...
						{contentImpact && (
							<div className="mt-3 flex items-start gap-2">
								...
								<p className="text-xs text-amber-700">
									If this content mentions trauma, violence, or other difficult
									topics, support resources will be suggested.
								</p>
							</div>
						)}
					</div>
					...
					<div className="mb-8 space-y-3">
						<label className="flex items-center">
							...
							<span className="text-gray-700">
								Log this reset (tracks exposure)
							</span>
						</label>
						<label className="flex items-center">
							<input
						...
						<label className="flex items-center">
							...
							/>
							<span className="text-gray-700">
								Share strategy anonymously with team
							</span>
						</label>
					</div>
