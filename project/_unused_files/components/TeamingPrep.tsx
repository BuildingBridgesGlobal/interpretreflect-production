						...
						<div className="space-y-6">
							<div>
								...
								<p className="text-sm text-gray-600 mb-4 italic">
									30 seconds • Based on Swift Trust Theory (Meyerson et al.,
									1996)
								</p>
							</div>
							...
							<div className="space-y-4">
								<div>
									...
									<div className="space-y-2">
										{[
											{
												value: "regular",
												label: "Regular partner - we know each other's style",
											},
											{
												value: "occasional",
												label:
													"Occasional partner - we've worked together before",
											},
											{
												value: "new",
												label: "New partner - first time teaming",
											},
											{
												value: "emergency",
												label: "Emergency pairing - no prior contact",
											},
										].map((option) => (
											<label
												key={option.value}
								...
								<div>
									...
									<div className="space-y-2">
										{[
											{
												value: "high-stakes",
												label: "High-stakes (medical, legal, crisis)",
											},
								...
								<div className="bg-blue-50 p-4 rounded-lg">
									<p className="text-sm text-blue-800">
										<strong>Research insight:</strong> Teams that acknowledge
										experience level reduce errors by 31% (Salas et al., 2005)
									</p>
								</div>
							</div>
						</div>
					...
					{currentStep === 2 && (
						<div className="space-y-6">
							<div>
								...
								<p className="text-sm text-gray-600 mb-4 italic">
									60 seconds • Based on Role Theory (Biddle, 1986) & Team
							...
							<div className="space-y-4">
								...
								<div className="bg-purple-50 p-4 rounded-lg">
									<p className="text-sm text-purple-800">
										<strong>Research insight:</strong> Teams with explicit
										signals show 44% smoother transitions (Kirchhoff, 2020)
									</p>
								</div>
							</div>
						</div>
					...
					{currentStep === 3 && (
						<div className="space-y-6">
							<div>
								...
								<p className="text-sm text-gray-600 mb-4 italic">
									60 seconds • Based on Team Backup Behavior research (Porter et
									al., 2003)
								</p>
							</div>
							...
							<div className="space-y-4">
								<div>
									...
									<div className="space-y-2">
										{[
											...
											{
												value: "wait10",
												label: "Give me 10 seconds to recover",
											},
								...
								<div>
									...
									<p className="text-xs text-gray-500 mt-1">
										Make it subtle but clear
									</p>
								</div>

								<div className="bg-green-50 p-4 rounded-lg">
									<p className="text-sm text-green-800">
										<strong>Research insight:</strong> Teams with backup
										protocols recover from errors 73% faster (McIntyre & Salas,
										1995)
									</p>
								</div>
							</div>
					...
					{currentStep === 4 && (
						<div className="space-y-6">
							<div>
								...
								<p className="text-sm text-gray-600 mb-4 italic">
									60 seconds • Based on Cognitive Load Theory in interpreting
									(Seeber, 2011)
								</p>
							</div>
							...
							<div className="space-y-4">
											...
											{[
												...
												>
													<input
														...
														onChange={(e) =>
															setPartnerACapacity(e.target.value)
														}
														className="mt-1 mr-3"
													/>
													<span className="text-gray-700">{option.label}</span>
											...
											{[
												...
												>
													<input
														...
														onChange={(e) =>
															setPartnerBCapacity(e.target.value)
														}
														className="mt-1 mr-3"
													/>
													<span className="text-gray-700">{option.label}</span>
								...
								<div>
									...
									<div className="space-y-2">
										{[
											...
											{
												value: "support",
												label: "Need to request break/support",
											},
										].map((option) => (
											<label
												key={option.value}
								...
								<div className="bg-orange-50 p-4 rounded-lg">
									<p className="text-sm text-orange-800">
										<strong>Research insight:</strong> Teams that openly assess
										capacity show 52% better performance (Gile, 2009)
									</p>
								</div>
							</div>
						</div>
					...
					{currentStep === 5 && (
						<div className="space-y-6">
							<div>
								...
								<p className="text-sm text-gray-600 mb-4 italic">
									45 seconds • Based on High Reliability Team research (Weick &
									Sutcliffe, 2001)
								</p>
							</div>
							...
							<div className="space-y-4">
								<div>
									...
									<div className="space-y-2">
										{[
											...
											{
												value: "self-correct",
												label: "Quick self-correct if critical",
											},
											{
												value: "partner-correct",
												label: "Partner corrects only if essential",
											},
										].map((option) => (
											<label
												key={option.value}
								...
								<div>
									...
									<div className="space-y-2">
										{[
											...
											{
												value: "jump",
												label: "Partner jumps in with correction",
											},
											{
												value: "write",
												label: "Write correction and slide over",
											},
											{
												value: "repeat",
												label: "Request repetition from speaker",
											},
										].map((option) => (
											<label
												key={option.value}
								...
								<div>
									...
									<div className="space-y-2">
										{[
											{
												value: "takeover",
												label: "Partner takes over immediately",
											},
											{ value: "ask", label: "Ask for repetition" },
											{
												value: "consult",
												label: "Quick whispered consultation",
											},
								...
								<div className="bg-red-50 p-4 rounded-lg">
									<p className="text-sm text-red-800">
										<strong>Research insight:</strong> Teams with error
										protocols maintain 89% accuracy vs 72% without (Napier,
										2015)
									</p>
								</div>
							</div>
							...
							<div className="space-y-4">
										...
										{[
											{
												...
												label: "Sprint Mode",
												description:
													"Critical short assignment, both give 100%",
												icon: "🏃",
											},
											{
												value: "marathon",
											...
											},
											{
												...
												label: "Tag Team",
												description:
													"Clear on/off switches, full recovery between",
												icon: "🏷️",
											},
										].map((option) => (
											<label
								...
								<div className="bg-yellow-50 p-4 rounded-lg">
									<p className="text-sm text-yellow-800">
										<strong>Research insight:</strong> Teams using energy
										strategies maintain performance 40% longer (Hale, 2007)
									</p>
								</div>
							</div>
						</div>
						...
						<div className="space-y-6">
							...
							<div className="bg-gradient-to-r from-blue-500 to-purple-500 p-6 rounded-xl text-white">
								...
								<p className="text-lg italic">
									"We are professional partners. We support without judgment. We
									succeed together."
								</p>
							</div>
							...
							<div className="bg-gray-50 p-4 rounded-lg">
								<h4 className="font-semibold text-gray-900 mb-3">
									The Science Behind Team Prep:
								</h4>
								<ul className="space-y-2 text-sm text-gray-700">
									<li>
										• <strong>Role clarity</strong> reduces cognitive overhead
										by 35% (Cannon-Bowers et al., 1993)
									</li>
									<li>
										• <strong>Explicit coordination</strong> improves accuracy
										by 28% (Hutchins, 1995)
									</li>
									<li>
										• <strong>Shared mental models</strong> decrease errors by
										45% (Mohammed et al., 2010)
									</li>
									<li>
										• <strong>Energy management</strong> extends team endurance
										by 50% (Blickensderfer et al., 2010)
									</li>
								</ul>
							</div>
						</div>
						...
						<div className="space-y-6">
							...
							<div className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-xl border-2 border-blue-200">
								...
								<div className="space-y-2 text-gray-800">
									...
									<p>
										<strong>Error handling:</strong> Minor: {minorErrors},
										Major: {majorErrors}
									</p>
									<p>
