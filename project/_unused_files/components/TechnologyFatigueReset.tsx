import { Eye, Headphones, Monitor, Move, Pause, Play, X } from "lucide-react";
...
export const TechnologyFatigueReset: React.FC<TechnologyFatigueResetProps> = ({
	onClose,
	onComplete,
}) => {
					...
					<div className="p-8">
						...
						<div className="mb-6">
							...
							<div className="grid grid-cols-2 gap-3">
								...
								<div className="p-4 bg-cyan-50 rounded-xl">
									...
									<p className="text-sm text-gray-600">
										Remove headphones, massage ears
									</p>
								</div>
						...
						<div className="mb-6 p-4 bg-gray-50 rounded-xl">
							<p className="text-sm text-gray-700">
								<strong>20-20-20 rule:</strong> Every 20 minutes, look 20 feet
								away for 20 seconds.
							</p>
						</div>
				...
				<div className="p-8">
					...
					<div className="mb-6">
						...
						<div className="space-y-2">
							{["Looking away", "Relaxing posture", "The break itself"].map(
								(option) => (
									<label key={option} className="flex items-center">
										<input
											type="radio"
					...
					<div className="mb-8">
						...
						<div className="space-y-2">
							{["Perfect timing", "Set reminder", "Try longer break"].map(
								(option) => (
									<label key={option} className="flex items-center">
										<input
											type="radio"
