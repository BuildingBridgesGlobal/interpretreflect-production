...
export const ValuesAlignmentCheckIn: React.FC<ValuesAlignmentCheckInProps> = ({
	onClose,
	onComplete,
}) => {
	const { user } = useAuth();
			...
			fields: [
				{
					...
					type: "textarea",
					placeholder:
						"What happened that made you question your values alignment?",
					required: true,
				},
				{
		...
		},
		{
			...
			fields: [
				...
				},
				{
					...
					label:
						"Did you feel you had to compromise any values? If so, which ones?",
					type: "textarea",
			...
			fields: [
				{
					id: "lesson_learned",
					label:
						"What have you learned about your values from this experience?",
					type: "textarea",
	...
	const handleSubmit = async () => {
		...
		try {
			...
			const dataToSave = {
				...
				values_reflection:
					formData.values_check ||
					formData.alignment_reflection ||
					"Values alignment completed",
				ethical_considerations:
					formData.ethical_tension ||
					formData.decision_values ||
