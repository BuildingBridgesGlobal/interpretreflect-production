...
import type { WellnessCheckInData } from "../lib/supabase";
...
export const WellnessCheckInEnhanced: React.FC<
	WellnessCheckInEnhancedProps
> = ({ onComplete, onClose }) => {
	const { user } = useAuth();
	...
	const validateSection = (section: number): boolean => {
		switch (section) {
			...
			case 7: // Closing
				return (
					formData.self_care_commitment.trim() !== "" &&
...
Completed: ${new Date().toLocaleString()}`;
	...
	const handleSubmit = async () => {
		...
		const finalData = {
			...
			timestamp: new Date().toISOString(),
			concerning_patterns:
				formData.overall_wellbeing <= 3 ||
				formData.physical_energy <= 3 ||
				formData.emotional_balance <= 3,
		...
		<div className="space-y-6">
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("overall_feeling", parseInt(e.target.value))
						}
						className="flex-1"
					/>
			...
			<div>
				...
				<input
					...
					onChange={(e) =>
						handleInputChange("last_break_taken", e.target.value)
					}
		...
		<div className="space-y-6">
			...
			<div>
				...
				<input
					...
					onChange={(e) =>
						handleInputChange("strongest_emotion", e.target.value)
					}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("emotional_patterns", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("avoided_feelings", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
		...
		<div className="space-y-6">
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("relaxation_areas", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
			...
			<div>
				<label className="block text-sm font-medium text-gray-700 mb-2">
					What physical symptoms have you been experiencing? (fatigue,
					headaches, tension, etc.)
				</label>
				<textarea
					value={formData.physical_symptoms}
					onChange={(e) =>
						handleInputChange("physical_symptoms", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
		...
		<div className="space-y-6">
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("energizing_aspects", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("draining_aspects", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("purpose_connection", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("boundaries_needing_attention", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
		...
		<div className="space-y-6">
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("available_support_systems", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("people_to_reach_out", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("recent_self_care", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("needed_resources", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("help_comfort_level", parseInt(e.target.value))
						}
						className="flex-1"
					/>
	...
	const renderNeedsIntentions = () => (
		<div className="space-y-6">
			<div>
				<label className="block text-sm font-medium text-gray-700 mb-2">
					What do you need most right now? (rest, connection, challenge,
					variety, etc.)
				</label>
				<textarea
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("today_wellness_step", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("longer_term_changes", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("week_wellness_priority", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={2}
				/>
	...
	const renderWellnessMetrics = () => (
		<div className="space-y-6">
			...
			<div>
				<label className="block text-sm font-medium text-gray-700 mb-2">
					<Activity className="inline w-4 h-4 mr-1" /> Rate your current energy
					level (1-10)
				</label>
				<div className="flex items-center space-x-4">
					<span className="text-sm">1</span>
					<input
						...
						value={formData.energy_level}
						onChange={(e) =>
							handleInputChange("energy_level", parseInt(e.target.value))
						}
						className="flex-1"
			...
			<div>
				<label className="block text-sm font-medium text-gray-700 mb-2">
					<AlertTriangle className="inline w-4 h-4 mr-1" /> Rate your current
					stress level (1-10)
				</label>
				<div className="flex items-center space-x-4">
					<span className="text-sm">1</span>
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("physical_energy", parseInt(e.target.value))
						}
						className="flex-1"
					/>
					<span className="text-sm">10</span>
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("emotional_balance", parseInt(e.target.value))
						}
						className="flex-1"
					/>
					<span className="text-sm">10</span>
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("mental_clarity", parseInt(e.target.value))
						}
						className="flex-1"
					/>
					<span className="text-sm">10</span>
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("social_connection", parseInt(e.target.value))
						}
						className="flex-1"
					/>
					<span className="text-sm">10</span>
			...
			<div>
				<label className="block text-sm font-medium text-gray-700 mb-2">
					<Briefcase className="inline w-4 h-4 mr-1" /> Professional
					Satisfaction
				</label>
				<div className="flex items-center space-x-4">
					<span className="text-sm">1</span>
			...
			<div>
				...
				<div className="flex items-center space-x-4">
					...
					<input
						...
						onChange={(e) =>
							handleInputChange("overall_wellbeing", parseInt(e.target.value))
						}
						className="flex-1"
					/>
					<span className="text-sm">10</span>
	...
	const renderClosingReflection = () => (
		<div className="space-y-6">
			<div>
				<label className="block text-sm font-medium text-gray-700 mb-2">
					Based on this check-in, what's one specific self-care action you'll
					take in the next 24 hours?
				</label>
				<textarea
					value={formData.self_care_commitment}
					onChange={(e) =>
						handleInputChange("self_care_commitment", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={3}
			...
			<div>
				...
				<textarea
					...
					onChange={(e) =>
						handleInputChange("gratitude_reflection", e.target.value)
					}
					className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent resize-none"
					rows={3}
	...
	const renderSection = () => {
		switch (currentSection) {
			...
			case 7:
				return renderClosingReflection();
			case 8:
			...
			<div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
				<div className="p-6 border-b border-gray-200">
					...
					<p className="text-gray-600 mb-4">
						Let's pause to check in with your emotional and physical wellbeing.
						This practice helps you stay connected to yourself and identify what
						you need to maintain balance in your interpreting practice.
					</p>
