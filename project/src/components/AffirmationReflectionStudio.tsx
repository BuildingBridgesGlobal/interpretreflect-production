...
export const AffirmationReflectionStudio: React.FC<
	AffirmationReflectionStudioProps
> = ({ onClose }) => {
	...
	const categories: AffirmationCategory[] = [
		...
		},
		{
			...
			description:
				"Acknowledging your capacity to navigate challenges and grow.",
		...
		},
		{
			...
			description:
				"Permission to be gentle with yourself and honor your humanity.",
		...
		},
		{
			...
			description:
				"Affirmations for grounding, focus, and being fully present, no matter what arises.",
		...
		},
		{
			...
			description:
				"Affirmations for recognizing the strength and diversity in all collaborative work.",
		...
		},
		{
			...
			description:
				"Affirmations for meeting change and challenge with curiosity and resilience.",
		...
		<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
			...
			>
				<div className="flex items-center justify-between p-6 border-b border-gray-200">
					<div>
						<h2
							id="affirmation-studio-heading"
							className="text-2xl font-bold text-gray-900"
						>
							Affirmation & Reflection Studio
						</h2>
						<p className="text-sm text-gray-600 mt-1">
							Gentle, conversational affirmations paired with thoughtful
							reflection
						</p>
					</div>
					<button
				...
				>
					<p className="text-gray-700 mb-8">
						Use anytime to nurture your relationship with yourself and your
						interpreting practice. Each category contains affirmations designed
						to support your wellbeing and professional growth.
					</p>
					...
					>
						{categories.map((category) => {
							...
							return (
								...
								>
									<div
										className={`inline-flex p-3 rounded-lg ${colors.bg} mb-4`}
									>
					...
					<section className="mt-12 p-6 bg-gray-50 rounded-xl">
						...
						<ul className="space-y-2 text-gray-600">
							...
							<li>
								• How can you carry one of these affirmations with you today?
							</li>
							<li>
								• What evidence from your experience supports these truths?
							</li>
						</ul>
					</section>
				</div>
						...
						>
							<div className="flex items-start justify-between mb-6">
								<div className="flex items-center">
									<div
										className={`${getColorClasses(activeDialogCategory.color).text} mr-3`}
									>
										{activeDialogCategory.icon}
									</div>
									<h4
										id={`${activeCategory}-dialog-heading`}
