						...
						<div className="flex items-center">
							...
							<div>
								...
								<p className="text-gray-600 mt-1">
									Make InterpretReflect suit your style and workflow. Set your
									experience, accessibility features, and interface
									preferences—all stored securely and adjustable at any time.
								</p>
							</div>
						</div>
					</div>
						...
						<section aria-labelledby="notification-settings">
							...
							<div className="space-y-4">
								...
								<div>
									...
									>
										...
										<span className="block text-xs text-gray-500 font-normal mt-1">
											Choose how often you'd like to be reminded to reflect on
											your wellbeing
										</span>
									</label>
											...
											{WEEKDAYS.map((day) => (
												<label key={day.value} className="flex items-center">
													<input
														...
														value={day.value}
														checked={
															preferences.custom_reminder_days?.includes(
																day.value,
															) || false
														}
														onChange={(e) => {
															const days =
																preferences.custom_reminder_days || [];
															if (e.target.checked) {
																setPreferences({
																	...preferences,
																	custom_reminder_days: [...days, day.value],
																});
															} else {
																setPreferences({
																	...preferences,
																	custom_reminder_days: days.filter(
																		(d) => d !== day.value,
																	),
																});
															}
								...
								<div>
									...
									>
										<Clock
											className="inline h-4 w-4 mr-1 text-indigo-600"
											aria-hidden="true"
										/>
									...
									>
										{[
											...
											>
												...
												/>
												<theme.icon
													className="h-4 w-4 mx-3 text-gray-600"
													aria-hidden="true"
												/>
							...
							<div className="space-y-4">
								...
								<div className="flex items-start">
									<div className="flex items-center h-5">
										<input
											...
											onChange={(e) =>
												setPreferences({
													...preferences,
													keyboard_shortcuts: e.target.checked,
												})
											}
											className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
									...
									<div className="ml-3">
										...
										>
											Navigate even faster: enable key commands for frequent
											actions
										</p>
										<button
											type="button"
								...
								<div className="flex items-start">
									<div className="flex items-center h-5">
										<input
											...
											onChange={(e) =>
												setPreferences({
													...preferences,
													screen_reader_mode: e.target.checked,
												})
											}
											className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
									...
									<div className="ml-3">
										...
										<p
											...
											className="text-xs text-gray-500 mt-1"
										>
											Optimizes site structure for full screen reader
											compatibility
										</p>
									</div>
								</div>
							...
							<div className="flex">
								...
								<div className="ml-3">
									...
									<p className="text-sm text-blue-700 mt-1">
										All preference selections are stored encrypted. Your choices
										never affect the privacy of your journal entries,
										reflections, or personal data.
									</p>
								</div>
							</div>
						</div>
