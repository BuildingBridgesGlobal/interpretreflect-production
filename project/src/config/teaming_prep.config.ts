...
export const TEAMING_PREP = {
	...
	sections: [
		{
			...
			fields: [
				...
				},
				{
					...
					max: 10,
					step: 1,
					label: "Teammate focus (0 to 10)",
				},
				{
					id: "one_word_feeling",
					type: "text",
					label: "One word for how you feel heading in",
					maxLength: 30,
					ariaLabel: "Emotion word",
				},
			],
		...
		},
		{
			...
			kind: "choice+text",
			title: "2. Signal Plan",
			promptMain: "What's your go signal? (Tap, glance, pause, key phrase?)",
	...
	closing: {
		...
		sub: "Over time, you'll see patterns in your readiness, stressors, and teamwork focus. Small rituals, big growth.",
	},
} as const;
