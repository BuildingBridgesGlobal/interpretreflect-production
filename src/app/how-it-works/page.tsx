...
import { ChevronRight, Zap, Brain, Target, Sparkles, ArrowRight, Play, Pause, RotateCcw, Heart, Activity, Clock, TrendingUp } from 'lucide-react'
...
export default function HowItWorksPage() {
  ...
  const MedicalCard = ({ step, isActive, index }: { step: any, isActive: boolean, index: number }) => (
    ...
    >
      ...
      <div className="relative medical-card p-6 rounded-2xl border border-gray-600/60 hover:border-gray-400/60 transition-all backdrop-blur-sm">
        {/* Header */}
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold text-gray-200 uppercase tracking-wide">{step.status}</span>
          </div>
        </div>

        {/* Content */}
        <h3 className="text-xl font-bold text-white mb-2 leading-tight">{step.title}</h3>
        <p className="text-gray-200 mb-3 text-base font-medium">{step.subtitle}</p>
        <p className="text-base text-gray-300 mb-5 leading-relaxed">{step.description}</p>

        {/* Metrics */}
        <div className="space-y-3 mb-5">
          <p className="text-sm font-semibold text-gray-400 uppercase tracking-wide mb-2">Performance Metrics</p>
          {step.metrics.map((metric: any, i: number) => (
            <div key={i} className="flex items-center justify-between bg-gray-900/40 rounded-lg px-3 py-2">
        ...
        <div className="space-y-2">
          <p className="text-sm font-semibold text-gray-400 uppercase tracking-wide mb-2">Key Benefits</p>
          {step.benefits.map((benefit: string, i: number) => (
            <div key={i} className="flex items-center gap-3">
              ...
              <span className="text-sm text-gray-200 font-medium leading-relaxed">{benefit}</span>
            </div>
          ))}
        </div>

        {/* Duration Badge */}
        <div className="absolute top-4 right-4 px-3 py-1 bg-gray-900/70 rounded-full text-sm text-gray-200 font-semibold border border-gray-600/50">
          {step.duration}
        </div>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <button 
                ...
                className="px-8 py-4 border-2 border-gray-500 text-gray-200 rounded-xl font-bold text-lg hover:bg-gray-800/60 hover:border-gray-400 hover:text-white transition-all inline-flex items-center gap-3 group dark:border-gray-600 dark:text-gray-300 dark:hover:border-gray-500"
              >
      ...
      <section className="relative z-10 py-20 bg-slate-900/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Clinical Evidence & Outcomes</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">Research-backed results from interpreter performance studies</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="medical-card p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">87% Performance Improvement</h3>
            ...
            <div className="medical-card p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">64% Burnout Reduction</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="medical-card p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">92% User Satisfaction</h3>
              <p className="text-gray-400 leading-relaxed">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/20 rounded-full border border-green-500/30 mb-8">
              <div className="w-2 h-2 bg-green-400 rounded-full status-blink"></div>
              <span className="text-green-400 text-sm font-medium">CLINICALLY PROVEN</span>
            </div>
