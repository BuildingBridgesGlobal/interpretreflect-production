...
import { X, RefreshCw, Move, Pause, FastForward, Clock } from 'lucide-react';
...
export const AssignmentResetAccessible: React.FC<AssignmentResetProps> = ({ onClose, onComplete }) => {
          ...
          <div className="p-8">
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 id="assignment-reset-title" className="text-xl font-normal" style={{ color: '#2D3748' }}>
                    Assignment Reset
                  </h2>
                ...
                {Object.entries(RESET_METHODS).map(([key, method]) => (
                  <li key={key}>
                    <button
                      ...
                      style={{
                        backgroundColor: selectedMethod === key ? '#F0F5ED' : '#F9FAFB',
                        borderColor: selectedMethod === key ? '#7A9B6E' : undefined,
                    ...
                    >
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="font-medium text-sm" style={{ color: '#2D3748' }}>{method.title}</p>
                          <p className="text-xs" style={{ color: '#4A5568' }}>{method.description}</p>
                        </div>
                      </div>
                    </button>
                  </li>
            ...
            <div className="mb-6 p-4 rounded-xl" style={{ backgroundColor: '#F0F5ED' }}>
              <p className="text-sm" style={{ color: '#2D3748' }}>
                <strong>Quick tip:</strong> Even 10 seconds helps! Regular resets prevent accumulation.
              </p>
            </div>
