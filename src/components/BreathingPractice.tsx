...
export const BreathingPractice: React.FC<BreathingPracticeProps> = ({ 
  ...
  const [breathingPath, setBreathingPath] = useState<'nose' | 'mouth' | 'combination'>('nose');
  ...
  const stopPractice = () => {
    ...
    if (duration > 30) { // Only show post-practice if practiced for more than 30 seconds
    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        ...
        <div className="flex space-x-4 mb-8">
          ...
          {!skipHolds && (
            <div className={`px-3 py-1 rounded-lg ${currentPhase === 'pause' ? 'bg-sage-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
              Pause
            </div>
          )}
          <div className={`px-3 py-1 rounded-lg ${currentPhase === 'exhale' ? 'bg-sage-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
            Exhale
          </div>
          {!skipHolds && (
            <div className={`px-3 py-1 rounded-lg ${currentPhase === 'rest' ? 'bg-sage-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
              Rest
            </div>
          )}
        </div>
        ...
        <div className="text-center text-sm text-gray-500 max-w-md">
          <p>
            If you feel dizzy or uncomfortable, return to your natural breathing.
            This is your practice - modify freely.
          </p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full"
                />
                <span className="text-sm text-gray-500">{inhaleCount} seconds</span>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full"
                />
                <span className="text-sm text-gray-500">{exhaleCount} seconds</span>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full"
                  />
                  <span className="text-sm text-gray-500">{pauseCount} seconds</span>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full"
                  />
                  <span className="text-sm text-gray-500">{restCount} seconds</span>
                </div>
              </div>
            )}
  ...
  const renderPostPractice = () => (
    <div className="p-8 max-w-2xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-900 mb-4">Gentle Reflection</h2>
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {['calming', 'energizing', 'neutral', 'uncomfortable'].map(feeling => (
              <button
                key={feeling}
              ...
              >
                {feeling === 'neutral' ? 'Neutral/no change' : 
                 feeling === 'uncomfortable' ? 'Slightly uncomfortable' :
        ...
        <div className="border-t pt-6">
          <h3 className="font-semibold text-gray-700 mb-4">Your Preferences:</h3>
          ...
          <div className="space-y-3">
            <label className="flex items-center">
              <input
                ...
                className="mr-3"
              />
              <span className="text-sm text-gray-700">Save these adjustments for next time</span>
            </label>
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={(e) => setReminderSchedule(e.target.checked ? '4_hours' : '')}
                className="mr-3"
              />
              <span className="text-sm text-gray-700 mr-2">Remind me to try this again in</span>
              {reminderSchedule && (
                <select
            ...
            <label className="flex items-center">
              <input
                ...
                className="mr-3"
              />
              <span className="text-sm text-gray-700">Show me a different practice next time</span>
            </label>
          </div>
        </div>
      ...
      >
        ...
        {!showPostPractice && (
          <div className="p-4 bg-sage-50 border-t border-sage-200">
            <h3 className="font-semibold text-sage-800 mb-2">How This Supports You:</h3>
            <p className="text-sm text-sage-700">
              This rhythmic breathing can help your nervous system find balance. 
              Many people find it settling, though everyone's experience is unique. 
              Some use this for focus, others for calm - discover what it offers you.
            </p>
          </div>
        )}
      </div>
