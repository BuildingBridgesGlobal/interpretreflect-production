...
import { ChevronLeft, ChevronRight, X, Stethoscope, Scale, GraduationCap, Brain, Building } from 'lucide-react';
...
export const ContextSpecificFramework: React.FC<ContextSpecificFrameworkProps> = ({ onClose, onComplete }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('Context reflection saved with insights:', result.reflection?.insights);
