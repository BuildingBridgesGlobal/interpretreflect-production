...
const DailyBurnoutGauge: React.FC<DailyBurnoutGaugeProps> = ({ onComplete, onClose }) => {
  ...
  const generatePersonalizedRecommendations = (answers: any, risk: string) => {
    ...
    if (answers.energyTank >= 4) {
      ...
      recommendations.push('Consider canceling or rescheduling non-essential tasks today');
    }
    ...
    if (answers.recoverySpeed >= 4) {
      ...
      recommendations.push('Try a restorative activity: gentle yoga, nature walk, or warm bath');
    }
    ...
    if (answers.performanceSignal >= 4) {
      ...
      recommendations.push('Consider requesting team support or a reduced schedule if possible');
    }
    ...
    switch (riskLevel) {
      ...
      case 'moderate':
        return {
          ...
          message: 'Some burnout indicators are elevated. Consider increasing recovery activities.',
      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl">
        {!showResults ? (
          <>
            <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-sage-50 to-green-50">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">Daily Burnout Gauge</h2>
            ...
            <div className="p-8">
              <div className="mb-8">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">{currentQ.text}</h3>
                <p className="text-sm text-gray-500 italic">{currentQ.subtext}</p>
              </div>
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>Why this matters:</strong> Daily burnout monitoring can predict and
                  prevent severe burnout with 84% accuracy when tracked consistently (Bakker &
                  Costa, 2014)
                </p>
              </div>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="mb-8">
                <div className="flex items-center justify-center mb-4">
                  <div className="text-center">
                    <div className="text-5xl font-bold text-gray-900">{totalScore.toFixed(1)}</div>
              ...
              <div className="space-y-3 mb-8">
                ...
                {Object.entries(answers).map(([key, value]) => {
                  ...
                  return (
                    ...
                    >
                      <span className="text-sm text-gray-700">{displayNames[key] || key}</span>
              ...
              {showContextFactors ? (
                <div className="bg-blue-50 border-2 border-blue-200 p-4 rounded-lg mb-6">
                  <h4 className="font-semibold text-blue-900 mb-3">Context Factors (Optional)</h4>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      {[
                        { key: 'hadBreaks', label: 'Had adequate breaks today' },
                        { key: 'teamSupport', label: 'Had team/peer support' },
                        { key: 'difficultSession', label: 'Had particularly difficult session(s)' },
                      ].map((item) => (
                        <div key={item.key} className="flex items-center justify-between">
                          ...
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                setContextFactors((prev) => ({ ...prev, [item.key]: true }))
                              }
                              className={`px-3 py-1 rounded-lg text-sm ${
                            ...
                            <button
                              onClick={() =>
                                setContextFactors((prev) => ({ ...prev, [item.key]: false }))
                              }
                              className={`px-3 py-1 rounded-lg text-sm ${
                                contextFactors[item.key as keyof typeof contextFactors] === false
                  ...
                  <ul className="space-y-2">
                    {personalizedRecommendations.map((rec, index) => (
                      ...
                      >
                        ...
                        <span
                          className={
                            index === 0 && (riskLevel === 'severe' || riskLevel === 'high')
                              ? 'font-semibold'
                              : ''
                          }
                        >
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-6">
                <h4 className="font-semibold text-gray-900 mb-2">The Science:</h4>
                <p className="text-sm text-gray-700 mb-2">
                  This assessment uses five evidence-based indicators of interpreter wellbeing:
                </p>
                <ul className="space-y-1 text-sm text-gray-600">
                  <li>
                    • <strong>Energy Tank:</strong> Resource conservation and depletion (Hobfoll,
                    1989)
                  </li>
                  <li>
                    • <strong>Recovery Speed:</strong> Allostatic load and resilience (McEwen, 1998)
                  </li>
                  <li>
                    • <strong>Emotional Leakage:</strong> Work-life boundary management (Hochschild,
                    1983)
                  </li>
                  <li>
                    • <strong>Performance Signal:</strong> Cognitive fatigue indicators (Hockey,
                    2013)
                  </li>
                  <li>
                    • <strong>Tomorrow Readiness:</strong> Anticipatory stress response (Gaab et
                    al., 2005)
                  </li>
                </ul>
                <p className="text-sm text-gray-700 mt-2">
                  Together, these provide a comprehensive picture of your current burnout risk and
                  recovery needs.
                </p>
              </div>
