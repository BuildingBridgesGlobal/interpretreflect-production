...
export const DirectCommunicationReflection: React.FC<DirectCommunicationReflectionProps> = ({ onClose, onComplete }) => {
  const { user } = useAuth();
  ...
  const sections = [
      ...
      fields: [
        {
          ...
          label: "Did I create opportunities for participants to express themselves directly?",
          type: 'textarea',
        ...
        {
          id: 'role_expansion',
          label: "Did I unintentionally take on more than a facilitative role? If so, describe.",
          type: 'textarea',
          placeholder: "Consider moments where your role may have expanded beyond facilitation...",
          required: true
        }
      ]
    },
    {
      ...
      icon: <ArrowRightLeft className="w-5 h-5" style={{ color: '#6B8B60' }} />,
      fields: [
        {
          id: 'difficult_intervention',
          label: "When communication became difficult, how did I step in?",
          type: 'textarea',
          placeholder: "Describe your approach to challenging communication moments...",
          required: true
        },
        {
          id: 'intervention_transparency',
          label: "Was my involvement transparent, professional, and respectful of each person's ability to communicate for themselves?",
          type: 'textarea',
          placeholder: "Assess the transparency and respect in your interventions...",
          required: true
        }
      ]
    },
    {
      ...
      fields: [
        {
          id: 'direct_address',
          label: "Were there moments where I needed to encourage participants to address one another (rather than me)?",
          type: 'textarea',
    ...
    },
    {
      ...
      fields: [
        {
          id: 'support_choices',
          label: "How did my choices support participants' ability to guide their own communication?",
          type: 'textarea',
        ...
        },
        {
          ...
          label: "Were there ways I unintentionally limited their independence? If so, how?",
          type: 'textarea',
          placeholder: "Consider any limitations you may have inadvertently created...",
          required: true
        }
      ]
    },
    {
      ...
      fields: [
        {
          id: 'accuracy_balance',
          label: "Did I balance accuracy with adaptability, considering register, cultural nuances, and tone?",
          type: 'textarea',
          placeholder: "Assess your balance between precision and cultural sensitivity...",
          required: true
        },
        {
          id: 'perspective_representation',
          label: "How did this ensure each person's perspective was fully represented?",
          type: 'textarea',
          placeholder: "Reflect on the completeness of perspective representation...",
          required: true
        }
      ]
    },
    {
      ...
      fields: [
        {
          id: 'growth_action',
          label: "What is one action I can carry forward to better support participants' independence?",
          type: 'textarea',
        ...
        {
          id: 'future_intention',
          label: "What intention will guide my approach to supporting self-expression in my next assignment?",
          type: 'textarea',
