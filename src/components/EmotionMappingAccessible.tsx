import { Brain, ChevronRight, Eye, Heart, Sparkles, X } from "lucide-react";
...
export const EmotionMappingAccessible: React.FC<EmotionMappingProps> = ({
	onClose,
	onComplete,
}) => {
		...
		const steps = {
			body: {
				...
				prompts: [
					...
					"Stomach - butterflies or tension?",
					"Shoulders - holding or relaxed?",
					...
					<div className="p-8">
							...
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-sm" style={{ color: "#4A5568" }}>
										Understand what you're feeling in response to interpreted
										content
									</p>
								</div>
							</div>
							...
							<ol className="space-y-3" role="list">
								<li className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm" style={{ color: "#4A5568" }}>
											Where do you notice something in your body? (chest,
											stomach, shoulders, jaw)
										</p>
									</div>
								</li>
								<li className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm" style={{ color: "#4A5568" }}>
											What emotion is present? (frustrated, sad, overwhelmed,
											angry, tired, numb)
										</p>
									</div>
								</li>
								<li className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm" style={{ color: "#4A5568" }}>
											What triggered this? (similar experience, against values,
								...
								<li className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm" style={{ color: "#4A5568" }}>
											What helps you regulate? (breathe, move, talk,
											acknowledge)
										</p>
									</div>
								</li>
						...
						>
							<p className="text-sm" style={{ color: "#2D3748" }}>
								<strong>Tip:</strong> Naming emotions reduces their intensity.
								Your brain calms down when you identify what's happening.
							</p>
						</div>
				...
				>
					<div className="p-8">
						...
						>
							{steps.map((step, index) => (
								<div
									...
									style={{
										backgroundColor:
											index <= currentStepIndex ? "#7A9B6E" : undefined,
									}}
						...
						<div className="text-center space-y-6">
							<div className="flex justify-center mb-4">{stepContent.icon}</div>
				...
				>
					<div className="p-8">
								...
								{["Yes", "Somewhat", "Still processing"].map((option) => (
									<button
										...
										className={`flex-1 py-2.5 px-3 rounded-xl transition-all text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 ${
											feelingClearer === option ? "text-white" : ""
										}`}
										style={{
											background:
						...
						<fieldset className="mb-8">
							...
							<div className="flex gap-2" role="radiogroup">
								{["I'm good", "More time", "Talk to someone"].map((option) => (
									<button
										key={option}
					...
					<div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
						<div className="p-6">
							...
							<div className="text-gray-600 mb-4">
								The neuroscience behind emotional awareness for interpreter
								recovery
							</div>
							...
							<div className="space-y-6">
								<div className="p-4 bg-[rgba(107,130,104,0.05)] rounded-lg">
									...
									<p className="text-green-800">
										<strong>Immediate stress reduction:</strong> When you name
										an emotion, brain imaging shows the amygdala (your brain's
										alarm system) decreases activity by up to 50%. This "name it
										to tame it" effect is particularly powerful for interpreters
										who absorb intense emotions during assignments. Simply
										labeling "frustration" or "compassion fatigue" begins the
										calming process instantly.
									</p>
								</div>
								...
								<div className="p-4 bg-blue-50 rounded-lg">
									...
									<p className="text-blue-800">
										<strong>Cognitive control restoration:</strong> The act of
										identifying emotions activates the prefrontal cortex—your
										brain's CEO—which had been suppressed during high-stress
										interpreting. This reactivation restores executive function,
										helping you transition from reactive mode to reflective
										processing, essential for maintaining professional
										boundaries and preventing vicarious trauma.
									</p>
								</div>
								...
								<div className="p-4 bg-purple-50 rounded-lg">
									...
									<p className="text-purple-800">
										...
										bridges the right brain (emotional experience) with the left
										brain (language and logic), creating neural integration. For
										interpreters who constantly navigate between languages and
										emotional contexts, this integration prevents emotional
										overwhelm and maintains cognitive flexibility throughout
								...
								<div className="p-4 bg-amber-50 rounded-lg">
									...
									<p className="text-amber-800">
										<strong>Precision reduces intensity:</strong> Research shows
										that people who distinguish between specific emotions
										("disappointed" vs. just "bad") experience 30% less
										emotional dysregulation. Interpreters who develop rich
										emotional vocabularies can process complex assignment
										content more effectively, reducing burnout and secondary
										trauma symptoms.
									</p>
								</div>
								...
								<div className="p-4 bg-indigo-50 rounded-lg">
									...
									<p className="text-indigo-800">
										<strong>Mental clarity restoration:</strong> The reflection
										phase of emotion mapping activates the default mode network,
										allowing your brain to process and file away emotional
										residue from interpreting sessions. This prevents emotional
										accumulation that can lead to interpreter fatigue, ensuring
										you start each new assignment with a clear cognitive and
										emotional slate.
									</p>
								</div>
							</div>
