 ...
 * Main Component
 */
export const EthicsMeaningCheckAccessible: React.FC<
	EthicsMeaningCheckAccessibleProps
> = ({ onClose, onComplete }) => {
	const { user } = useAuth();
	...
	const handleSubmit = async () => {
		...
		if (isSaving || hasSaved) {
			console.log(
				"ValuesAlignment - Already saving or saved, ignoring duplicate click",
			);
			return;
		}
		...
		try {
			...
			const dataToSave = {
				...
				values_reflection:
					formData.values_tension ||
					formData.values_alignment ||
					"Values alignment completed",
				ethical_considerations:
					formData.ethical_tensions ||
					formData.impact_alignment ||
					"Values check completed",
			};
			...
			if (!result.success) {
				throw new Error(
					result.error || "Failed to save values alignment check-in",
				);
			}
				...
				<div className="space-y-6">
					...
					>
						...
						<p className="mb-6" style={{ color: "#5A5A5A" }}>
							This reflection helps you navigate ethical challenges, maintain
							professional boundaries, and connect with the deeper meaning in
							your work. Your values and integrity are essential to sustainable
							practice.
						</p>
					</div>
						...
						<div className="grid grid-cols-2 gap-3">
							{[
								...
								<button
									key={trigger.value}
									onClick={() =>
										handleFieldChange("check_in_trigger", trigger.value)
									}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("recent_challenge", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("emotional_state", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("ethical_tensions", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("value_conflicts", e.target.value)
							}
					...
					<div>
						...
						<div className="flex items-center space-x-4">
							<input
								...
								onChange={(e) =>
									handleFieldChange("ethical_clarity", parseInt(e.target.value))
								}
								className="flex-1"
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("boundary_status", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("boundary_challenges", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("professional_voice", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("work_meaning", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("pride_moments", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("positive_impact", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("growth_areas", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("learning_insights", e.target.value)
							}
				...
				<div className="space-y-6">
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("available_support", e.target.value)
							}
					...
					<div>
						...
						<div className="flex items-center space-x-4">
							<input
								...
								onChange={(e) =>
									handleFieldChange("support_comfort", parseInt(e.target.value))
								}
								className="flex-1"
								style={{ accentColor: "#5B9378" }}
							/>
				...
				<div className="space-y-6">
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("tech_boundaries", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("innovation_thoughts", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("ethical_commitment", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("boundary_commitment", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("growth_commitment", e.target.value)
							}
