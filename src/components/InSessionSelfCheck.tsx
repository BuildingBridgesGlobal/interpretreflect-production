 ...
 */
export const InSessionSelfCheck: React.FC<InSessionSelfCheckProps> = ({ onClose, onComplete }) => {
  const { user } = useAuth();
  ...
  const validateSection = (sectionIndex: number): boolean => {
    ...
    if (sectionIndex === 9) { // Commitment section
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <p className="mb-6" style={{ color: '#5A5A5A' }}>
              This rapid self-assessment helps you monitor and adjust your interpreting 
              performance in real-time. Research shows that real-time monitoring improves 
              interpreter accuracy by 35%.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                onChange={(e) => handleFieldChange('demand_management', parseInt(e.target.value))}
                className="flex-1"
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('demand_management_notes', e.target.value)}
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                onChange={(e) => handleFieldChange('control_effectiveness', parseInt(e.target.value))}
                className="flex-1"
                style={{ accentColor: '#6B8B60' }}
              />
              <span className="text-2xl font-bold px-4 py-2 rounded-lg" 
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('strategy_adjustments', e.target.value)}
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('focus_maintenance', e.target.value)}
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                onChange={(e) => handleFieldChange('boundary_maintenance', parseInt(e.target.value))}
                className="flex-1"
                style={{ accentColor: '#6B8B60' }}
              />
              <span className="text-2xl font-bold px-4 py-2 rounded-lg" 
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('boundary_concerns', e.target.value)}
          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                onChange={(e) => handleFieldChange('flow_impact', parseInt(e.target.value))}
                className="flex-1"
                style={{ accentColor: '#6B8B60' }}
              />
              <span className="text-2xl font-bold px-4 py-2 rounded-lg" 
        ...
        <div className="space-y-6">
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('cultural_factors', e.target.value)}
          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                onChange={(e) => handleFieldChange('cultural_success', parseInt(e.target.value))}
                className="flex-1"
                style={{ accentColor: '#6B8B60' }}
              />
              <span className="text-2xl font-bold px-4 py-2 rounded-lg" 
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                onChange={(e) => handleFieldChange('role_adherence', parseInt(e.target.value))}
                className="flex-1"
                style={{ accentColor: '#6B8B60' }}
              />
              <span className="text-2xl font-bold px-4 py-2 rounded-lg" 
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('role_challenges', e.target.value)}
        ...
        <div className="space-y-6">
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('team_support_needed', e.target.value)}
          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                onChange={(e) => handleFieldChange('support_urgency', parseInt(e.target.value))}
                className="flex-1"
                style={{ accentColor: '#6B8B60' }}
              />
              <span className="text-2xl font-bold px-4 py-2 rounded-lg" 
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                onChange={(e) => handleFieldChange('emotional_response', parseInt(e.target.value))}
                className="flex-1"
                style={{ accentColor: '#6B8B60' }}
              />
              <span className="text-2xl font-bold px-4 py-2 rounded-lg" 
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('emotional_strategies', e.target.value)}
        ...
        <div className="space-y-6">
          <div>
            ...
            {errors.immediate_action && (
              <p className="text-sm text-red-500 mt-1">{errors.immediate_action}</p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                onChange={(e) => handleFieldChange('overall_status', parseInt(e.target.value))}
                className="flex-1"
                style={{ accentColor: '#6B8B60' }}
              />
              <span className="text-2xl font-bold px-4 py-2 rounded-lg" 
