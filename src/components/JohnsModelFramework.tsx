...
import { ChevronLeft, ChevronRight, X, FileText, Eye, User, Scale, BookOpen, RotateCcw } from 'lucide-react';
...
export const JohnsModelFramework: React.FC<JohnsModelFrameworkProps> = ({ onClose, onComplete }) => {
