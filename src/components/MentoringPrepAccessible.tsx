...
import { CommunityIcon, TargetIcon, SecureLockIcon, HeartPulseIcon, NotepadIcon } from './CustomIcon';
  ...
  const renderProgressIndicator = () => (
    <div className="mb-8">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Mentoring Preparation</h2>
          <p className="text-sm text-gray-600">Thoughtful preparation for mentoring success</p>
        </div>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) => handleInputChange('mentoringContext', e.target.value)}
        />
      </div>
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          ...
          <input
            ...
            onChange={(e) => handleInputChange('emotionalReadiness', parseInt(e.target.value))}
            className="flex-1"
            style={{
              accentColor: '#2e7d32'
            }}
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          ...
          <input
            ...
            onChange={(e) => handleInputChange('physicalReadiness', parseInt(e.target.value))}
            className="flex-1"
            style={{
              accentColor: '#2e7d32'
            }}
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange('anticipatedDemands.environmental', e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange('anticipatedDemands.interpersonal', e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange('anticipatedDemands.paralinguistic', e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange('anticipatedDemands.intrapersonal', e.target.value)}
            />
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange('controlStrategies.environmental', e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange('controlStrategies.interpersonal', e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange('controlStrategies.paralinguistic', e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange('controlStrategies.intrapersonal', e.target.value)}
            />
          </div>
        </div>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="space-y-2">
          {['Mindfulness', 'Breathing exercises', 'Visualization', 'Progressive relaxation', 'Affirmations', 'Physical movement'].map(technique => (
            <label key={technique} className="flex items-center gap-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer">
              <input
                type="checkbox"
                checked={formData.focusTechniques.includes(technique)}
                onChange={(e) => {
                  if (e.target.checked) {
                    handleInputChange('focusTechniques', [...formData.focusTechniques, technique]);
                  } else {
                    handleInputChange('focusTechniques', formData.focusTechniques.filter(t => t !== technique));
                  }
                }}
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) => handleInputChange('groundingPractices', e.target.value)}
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) => handleInputChange('triggerManagement', e.target.value)}
        />
      </div>
    </div>
  );
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => handleInputChange('intentionStatement', e.target.value)}
        />
      </div>
