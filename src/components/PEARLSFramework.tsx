...
import { ChevronLeft, ChevronRight, X, Users, Heart, Shield, CheckCircle, LifeBuoy, Activity } from 'lucide-react';
...
export const PEARLSFramework: React.FC<PEARLSFrameworkProps> = ({ onClose, onComplete }) => {
