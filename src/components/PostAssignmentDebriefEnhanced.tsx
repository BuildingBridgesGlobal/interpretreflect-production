...
import {
  ...
  RefreshCw, Eye, ChevronDown, ChevronUp, BarChart3
} from 'lucide-react';
import { supabase, PostAssignmentDebriefData, PreAssignmentPrepData, ReflectionEntry } from '../lib/supabase';
...
const EMOTION_OPTIONS = [
  'Relieved', 'Proud', 'Exhausted', 'Satisfied', 'Frustrated',
  'Accomplished', 'Anxious', 'Energized', 'Disappointed', 'Calm',
...
export const PostAssignmentDebriefEnhanced: React.FC<PostAssignmentDebriefEnhancedProps> = ({ 
  ...
  const handleFieldChange = (field: keyof PostAssignmentDebriefData, value: any) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
  ...
  const handleEmotionToggle = (emotion: string) => {
    ...
    if (currentEmotions.includes(emotion)) {
      handleFieldChange('emotions_during', currentEmotions.filter(e => e !== emotion));
    } else {
    ...
    switch (sectionIndex) {
      ...
      case 1: // Revisiting Predictions
        if (!formData.confidence_accuracy.trim()) {
          newErrors.confidence_accuracy = 'Please reflect on your confidence assessment';
        }
        break;
      case 2: // Assignment Execution
        if (!formData.assignment_unfolded.trim()) {
          newErrors.assignment_unfolded = 'Please describe how the assignment unfolded';
        }
      ...
      case 3: // Emotional Experience
        ...
        if (!formData.body_experience.trim()) {
          newErrors.body_experience = 'Please describe your physical experience';
        }
        break;
...
Generated: ${new Date().toLocaleString()}`;
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const flowStateAchieved = formData.flow_struggle_moments.toLowerCase().includes('flow');
  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          >
            <h3 className="text-lg font-semibold mb-4" style={{ color: '#047857' }}>
              Opening Context
            </h3>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleFieldChange('experience_word', e.target.value)}
                ...
                {errors.experience_word && (
                  <p className="text-sm text-red-500 mt-1">{errors.experience_word}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.most_unexpected && (
                  <p className="text-sm text-red-500 mt-1">{errors.most_unexpected}</p>
                )}
              </div>
        ...
        <div className="space-y-6">
              ...
              {showPrepData && (
                ...
                >
                  <div className="space-y-3">
                    <div>
                      <span className="font-medium">Assignment Type:</span> {prepData.assignment_type} ({prepData.assignment_format})
                    </div>
                    <div>
                      <span className="font-medium">Pre-Confidence:</span> {prepData.confidence_level}/10
                    </div>
                    <div>
                      <span className="font-medium">Anticipated Challenges:</span> {prepData.anticipated_challenges}
                    </div>
                    <div>
                      <span className="font-medium">Key Strategies:</span> {prepData.key_strategies}
                    </div>
                    <div>
                      <span className="font-medium">Initial Emotions:</span> {prepData.current_emotions.join(', ')}
                    </div>
                    <div>
                      <span className="font-medium">Your Intention:</span> {prepData.assignment_intention}
                    </div>
                    <div>
                      <span className="font-medium">Preparedness Rating:</span> {prepData.preparedness_rating}/10
                    </div>
                  </div>
                </div>
              )}
          ...
          <div>
            ...
            {errors.confidence_accuracy && (
              <p className="text-sm text-red-500 mt-1">{errors.confidence_accuracy}</p>
            )}
          </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            {errors.assignment_unfolded && (
              <p className="text-sm text-red-500 mt-1">{errors.assignment_unfolded}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.strategies_used && (
              <p className="text-sm text-red-500 mt-1">{errors.strategies_used}</p>
            )}
          </div>
          ...
          {prepData && (prepData.assignment_format === 'virtual' || prepData.assignment_format === 'hybrid') && (
            <div>
              <label className="block text-sm font-medium mb-2" style={{ color: '#047857' }}>
          ...
          {prepData && (prepData.assignment_format === 'in-person' || prepData.assignment_format === 'hybrid') && (
            <div>
              <label className="block text-sm font-medium mb-2" style={{ color: '#047857' }}>
            ...
            <div>
              ...
              <div className="flex items-center space-x-4">
                <input
                  ...
                  onChange={(e) => handleFieldChange('technical_accuracy', Number(e.target.value))}
                  className="flex-1"
                  style={{ accentColor: '#10B981' }}
                />
            ...
            <div>
              ...
              <div className="flex items-center space-x-4">
                <input
                  ...
                  onChange={(e) => handleFieldChange('communication_effectiveness', Number(e.target.value))}
                  className="flex-1"
                  style={{ accentColor: '#10B981' }}
                />
                <span className="w-12 text-center font-semibold" style={{ color: '#1A1A1A' }}>
        ...
        <div className="space-y-6">
          <div>
            ...
            {errors.emotions_during && (
              <p className="text-sm text-red-500 mt-1">{errors.emotions_during}</p>
            )}
            <input
              type="text"
          ...
          <div>
            ...
            {errors.body_experience && (
              <p className="text-sm text-red-500 mt-1">{errors.body_experience}</p>
            )}
          </div>
          ...
          <div>
            <label className="block text-sm font-medium mb-2" style={{ color: '#047857' }}>
              What self-regulation strategies did you use? How effective were they?
            </label>
            <textarea
              value={formData.self_regulation}
              onChange={(e) => handleFieldChange('self_regulation', e.target.value)}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleFieldChange('current_emotional_state', e.target.value)}
        ...
        <div className="space-y-6">
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('unexpected_challenges', e.target.value)}
              placeholder="Describe challenges you didn't anticipate..."
              rows={3}
              className="w-full px-4 py-3 border rounded-lg resize-none focus:ring-2 focus:ring-emerald-500"
              style={{
                borderColor: errors.unexpected_challenges ? '#ef4444' : '#E5E7EB'
              }}
            />
            {errors.unexpected_challenges && (
              <p className="text-sm text-red-500 mt-1">{errors.unexpected_challenges}</p>
            )}
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('real_time_adaptations', e.target.value)}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('problem_solving_moment', e.target.value)}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('unfamiliar_content_handling', e.target.value)}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('would_do_differently', e.target.value)}
        ...
        <div className="space-y-6">
          <div>
            ...
            {errors.skills_strengthened && (
              <p className="text-sm text-red-500 mt-1">{errors.skills_strengthened}</p>
            )}
          </div>
          ...
          <div>
            <label className="block text-sm font-medium mb-2" style={{ color: '#047857' }}>
              What specific feedback did you receive (if any)? How will you integrate it?
            </label>
            <textarea
        ...
        <div className="space-y-6">
          <div>
            ...
            {errors.recovery_practices && (
              <p className="text-sm text-red-500 mt-1">{errors.recovery_practices}</p>
            )}
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('unresolved_concerns', e.target.value)}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('future_boundaries', e.target.value)}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('celebration_acknowledgment', e.target.value)}
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                ...
                {prepData && (
                  <p className="text-sm text-gray-600 mt-1">
                    Pre-assignment: {prepData.energy_level}/10 → Post: {formData.energy_level_post}/10
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {prepData && (
                  <p className="text-sm text-gray-600 mt-1">
                    Pre-assignment: {prepData.stress_anxiety_level}/10 → Post: {formData.stress_level_post}/10
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {prepData && (
                  <p className="text-sm text-gray-600 mt-1">
                    Pre-assignment confidence: {prepData.confidence_level}/10 → Future confidence: {formData.future_confidence}/10
                  </p>
                )}
              </div>
        ...
        <div className="space-y-6">
          {prepData && (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="font-medium">Confidence:</span> {prepData.confidence_level}/10 → {formData.future_confidence}/10
                </div>
                <div>
                  <span className="font-medium">Stress:</span> {prepData.stress_anxiety_level}/10 → {formData.stress_level_post}/10
                </div>
                <div>
                  <span className="font-medium">Energy:</span> {prepData.energy_level}/10 → {formData.energy_level_post}/10
                </div>
                <div>
                  <span className="font-medium">Preparedness → Accomplishment:</span> {prepData.preparedness_rating}/10 → {formData.accomplishment_sense}/10
                </div>
              </div>
            </div>
          )}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('challenges_comparison', e.target.value)}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('preparedness_comparison', e.target.value)}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('emotional_comparison', e.target.value)}
              placeholder="Describe your emotional journey..."
              rows={3}
              className="w-full px-4 py-3 border rounded-lg resize-none focus:ring-2 focus:ring-emerald-500"
            />
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
              {[0, 1, 2].map((index) => (
                <input
                  ...
                  style={{
                    borderColor: errors.three_insights && !formData.three_insights[index]?.trim() ? '#ef4444' : '#E5E7EB'
                  }}
                />
              ))}
          ...
          <div>
            ...
            {errors.proudest_moment && (
              <p className="text-sm text-red-500 mt-1">{errors.proudest_moment}</p>
            )}
          </div>
          ...
          >
            ...
            <div className="space-y-2 text-sm">
              <p><strong>Performance Satisfaction:</strong> {formData.performance_satisfaction}/10</p>
              <p><strong>Technical Accuracy:</strong> {formData.technical_accuracy}/10</p>
              <p><strong>Communication Effectiveness:</strong> {formData.communication_effectiveness}/10</p>
              <p><strong>Future Confidence:</strong> {formData.future_confidence}/10</p>
              <p><strong>Key Growth Area:</strong> {formData.skills_strengthened}</p>
            </div>
          </div>
        </div>
      )
          ...
          >
            ...
            <div className="mt-6 space-y-3">
              ...
              <p className="text-center text-sm text-gray-600">
                Your debrief has been saved and linked to your Growth Insights tracker
              </p>
            </div>
          </div>
        </div>
