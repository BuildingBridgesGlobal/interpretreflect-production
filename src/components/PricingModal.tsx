      ...
      <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="relative p-6 border-b border-gray-200 bg-gradient-to-r from-sage-50 to-green-50">
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <span className="text-sm text-gray-600">Early adopter pricing available</span>
          </div>

          <h2 className="text-3xl font-bold text-gray-900 mb-2">Choose Your Wellness Journey</h2>

          {burnoutScore && (
            <div className="mt-4 p-4 bg-white bg-opacity-70 rounded-lg">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600">Your Burnout Assessment Score</p>
              ...
              <p className="text-sm mt-2 text-gray-700">{getRiskMessage(riskLevel)}</p>
            </div>
          )}
        </div>
        ...
        <div className="p-6">
            ...
            <div className="rounded-xl border-2 border-sage-500 relative overflow-hidden">
              ...
              <div className="p-6 mt-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-green-600 mt-1">Beta pricing - Lock it in forever!</p>
                </div>
                ...
                <ul className="space-y-3 mb-6">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 mr-2 mt-0.5 text-green-500 flex-shrink-0" />
                    <span className="text-sm text-gray-700">Data export for personal tracking</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 mr-2 mt-0.5 text-green-500 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                ...
                <button
                  ...
                  style={{
                    background: 'linear-gradient(to right, #6B8B60, #5F7F55)',
                    color: '#FFFFFF',
                    padding: '12px 24px',
                    borderRadius: '8px',
                    border: 'none',
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 4px 12px rgba(107, 139, 96, 0.3)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background =
                      'linear-gradient(to right, #6B8B60, #5F7F55)';
                    e.currentTarget.style.transform = 'translateY(0)';
                    e.currentTarget.style.boxShadow = 'none';
                  }}
                >
                  Start Essential Plan - $12/month
                  <ArrowRight className="w-5 h-5 ml-2" style={{ display: 'inline-block' }} />
                </button>

                {riskLevel && (riskLevel === 'high' || riskLevel === 'severe') && (
            ...
            <div className="rounded-xl border-2 border-gray-300 relative opacity-75">
              ...
              <div className="p-6 mt-8">
                ...
                <div className="mb-6">
                  ...
                  <span className="text-gray-600">/month</span>
                  <p className="text-sm text-gray-500 mt-1">Early bird pricing when launched</p>
                </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <p className="text-center text-xs text-gray-500 mt-4">
              Join hundreds of interpreters taking control of their wellness journey
            </p>
          </div>
        </div>
      </div>
      ...
      {showSuccessMessage && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] p-4">
          <div className="bg-white rounded-2xl p-8 max-w-md text-center shadow-2xl">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Authenticated Successfully!</h3>
