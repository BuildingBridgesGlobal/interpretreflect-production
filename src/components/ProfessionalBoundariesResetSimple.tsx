      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="rounded-3xl max-w-2xl w-full bg-white">
          <div className="p-8">
            ...
            {/* Reset Options */}
            <div className="mb-6">
              <p className="text-sm font-medium mb-3 text-gray-700">What helps you return to center?</p>
              <div className="space-y-3">
                <div className="p-3 bg-rose-50 rounded-xl">
                  <h3 className="font-medium text-gray-800">Ground Yourself</h3>
                  <p className="text-sm text-gray-600">Touch your desk, feel your feet</p>
                </div>
                <div className="p-3 bg-orange-50 rounded-xl">
                  <h3 className="font-medium text-gray-800">Remember Your Role</h3>
                  <p className="text-sm text-gray-600">"I interpreted professionally"</p>
                </div>
        ...
        <div className="rounded-3xl max-w-lg w-full bg-white">
          <div className="p-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold text-gray-900">Let's Step Back</h2>
              <button onClick={onClose} className="p-2 hover:bg-gray-100 rounded-xl">
                <X className="w-6 h-6" />
              </button>
            </div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="rounded-3xl max-w-lg w-full bg-white">
        <div className="p-8">
          ...
          {/* Feeling better */}
          <div className="mb-6">
            <p className="text-gray-700 mb-3">Feeling more separated from it?</p>
            <div className="flex gap-3">
