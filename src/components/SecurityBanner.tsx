...
import { Shield, Lock, AlertTriangle, Info, X, Clock, LogOut, Eye } from 'lucide-react';
...
export const SecurityBanner: React.FC<SecurityBannerProps> = ({
  ...
  const securityTips = [
    {
      message: 'Your data is encrypted at rest and in transit using 256-bit AES encryption.',
      icon: Lock,
      type: 'info' as const,
    },
    {
    ...
    {
      message: 'We follow HIPAA guidelines to protect your wellness information.',
      icon: Shield,
      type: 'success' as const,
    },
    {
      message: 'Your session will automatically timeout after 30 minutes of inactivity.',
      icon: Clock,
      type: 'info' as const,
    },
    {
        ...
        <div className="p-6">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-6">
            <p className="text-sm text-yellow-900">
              <strong>Why does this happen?</strong> Auto-logout protects your data if you forget to sign out on a shared device.
            </p>
          </div>
