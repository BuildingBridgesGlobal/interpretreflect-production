...
import { ChevronLeft, ChevronRight, X, Target, Handshake, Shield, MessageSquare, Heart } from 'lucide-react';
...
export const SkillSpecificFramework: React.FC<SkillSpecificFrameworkProps> = ({ onClose, onComplete }) => {
