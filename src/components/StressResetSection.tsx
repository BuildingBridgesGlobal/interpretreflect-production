...
export const StressResetSection: React.FC<StressResetSectionProps> = ({
  onTechniqueStart,
  onTechniqueComplete
}) => {
      ...
      >
        ...
        >
          ...
          <p className="text-sm mb-4" style={{ color: '#2A2A2A', lineHeight: '1.6' }}>
            <strong>Neuroscience:</strong> Guided breathing activates your body's relaxation response, calming the nervous system after high-pressure interpreting.
          </p>
        ...
        >
          ...
          <p className="text-sm mb-4" style={{ color: '#2A2A2A', lineHeight: '1.6' }}>
            <strong>Neuroscience:</strong> Somatic awareness activates the insula cortex, helping release physical holding and reset your nervous system.
          </p>
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-8">
            <div className="flex justify-between items-start mb-6">
              <h2 className="text-2xl font-bold" style={{ color: '#0D3A14' }}>
                {selectedTechnique === 'breathing-practice' && 'Breathing Practice'}
