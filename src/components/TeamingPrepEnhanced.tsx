...
import type { TeamingPrepEnhancedData } from "../lib/supabase";
...
const TeamingPrepEnhanced: React.FC<TeamingPrepEnhancedProps> = ({
	onClose,
	onComplete,
}) => {
	const { user } = useAuth();
	...
	const handleFieldChange = (
		field: keyof TeamingPrepEnhancedData,
		value: string | number,
	) => {
		setFormData((prev) => ({
			...prev,
		...
		switch (sectionIndex) {
			...
			case 2: // Communication Plan
				...
				if (
					...
					!formData.virtual_handoff_strategy?.trim()
				) {
					newErrors.virtual_handoff_strategy =
						"Please describe your virtual handoff strategy";
				}
				if (
					(formData.assignment_type === "in-person" ||
						formData.assignment_type === "hybrid") &&
					!formData.physical_cues?.trim()
				) {
	...
	const handleSave = async () => {
		...
		try {
			...
			const finalData = {
				...
				team_context:
					formData.context || formData.assignment_context || "Team preparation",
			};
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("handoff_signal", e.target.value)
							}
					...
					{(formData.assignment_type === "virtual" ||
						...
						<div>
							...
							<textarea
								...
								onChange={(e) =>
									handleFieldChange("virtual_handoff_strategy", e.target.value)
								}
								placeholder="Describe your virtual communication strategy..."
								rows={2}
								className="w-full px-4 py-3 border rounded-lg resize-none focus:ring-2 focus:ring-sage-500"
								style={{
									borderColor: errors.virtual_handoff_strategy
										? "#ef4444"
										: "#E8E5E0",
								}}
							/>
					...
					{(formData.assignment_type === "in-person" ||
						...
						<div>
							...
							<textarea
								...
								onChange={(e) =>
									handleFieldChange("physical_cues", e.target.value)
								}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("communication_style", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("feedback_preferences", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("boundaries_preferences", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("debriefing_plan", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("typical_stressor", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("stress_management_plan", e.target.value)
							}
					...
					{(formData.assignment_type === "virtual" ||
						...
						<div>
							...
							<textarea
								...
								onChange={(e) =>
									handleFieldChange("virtual_challenges", e.target.value)
								}
					...
					{(formData.assignment_type === "in-person" ||
						...
						<div>
							...
							<textarea
								...
								onChange={(e) =>
									handleFieldChange("environmental_challenges", e.target.value)
								}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("anticipated_obstacles", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("skills_to_develop", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("conflict_management", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("unique_strengths", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("support_needs", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("transition_strategy", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("dynamic_not_working_plan", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("corrections_approach", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("roles_responsibilities", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("success_description", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("specific_commitments", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("desired_reputation", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("fatigue_support_plan", e.target.value)
							}
				...
				<div className="space-y-6">
					...
					>
						...
						<p className="mb-4" style={{ color: "#5A5A5A" }}>
							Based on your reflection, write one intention statement for how
							you'll show up in this team interpreting assignment.
						</p>
					...
					{showSummary && (
						...
						>
							...
							<p className="mb-4" style={{ color: "#5A5A5A" }}>
								Your preparation has been saved. You'll revisit these responses
								in your reflection after the assignment.
							</p>
