...
import { X, Monitor, Activity, Move, Clock } from 'lucide-react';
...
export const TechnologyFatigueResetAccessible: React.FC<TechnologyFatigueResetProps> = ({ onClose, onComplete }) => {
          ...
          <div className="p-8">
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 id="tech-fatigue-title" className="text-xl font-normal" style={{ color: '#2D3748' }}>
              ...
              <ol className="space-y-3" role="list">
                <li className="p-3 rounded-xl flex items-start gap-3" style={{ backgroundColor: '#F0F5ED' }}>
                  ...
                  <div className="flex-1">
                    <h4 className="font-medium" style={{ color: '#2D3748' }}>Posture</h4>
                ...
                <li className="p-3 rounded-xl flex items-start gap-3" style={{ backgroundColor: '#F0F5ED' }}>
                  ...
                  <div className="flex-1">
                    <h4 className="font-medium" style={{ color: '#2D3748' }}>Distance</h4>
                    <p className="text-sm mt-1" style={{ color: '#4A5568' }}>
            ...
            <div className="mb-6 p-4 rounded-xl" style={{ backgroundColor: '#F5F9F3' }}>
              <div className="flex items-start gap-3">
                <Clock className="w-5 h-5 mt-0.5 flex-shrink-0" style={{ color: '#5C7F4F' }} />
                <div>
                  <p className="text-sm font-medium mb-1" style={{ color: '#2D3748' }}>
                    20-20-20 Rule
                  </p>
                  <p className="text-sm" style={{ color: '#4A5568' }}>
            ...
            <div className="flex justify-center gap-2 mb-8" role="group" aria-label="Progress steps">
              {['posture', 'distance'].map((step, index) => (
                <div
                  ...
                  style={{
                    backgroundColor: index <= currentStepIndex ? '#7A9B6E' : '#E2E8F0'
                  }}
    ...
    <div className="fixed inset-0 bg-white bg-opacity-95 flex items-center justify-center z-50 p-4">
      ...
      >
        <div className="p-8 text-center">
          ...
          <h2 id="complete-title" className="text-xl font-normal mb-2" style={{ color: '#2D3748' }}>
          ...
          <div className="p-3 rounded-xl" style={{ backgroundColor: '#F5F9F3' }}>
