...
export const WaitlistModal: React.FC<WaitlistModalProps> = ({ isOpen, onClose, plan }) => {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">
                Join the {plan === 'professional' ? 'Professional' : 'Organizations'} Waitlist
              </h2>
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <p className="text-xs text-center text-gray-500">
              ...
              {plan === 'professional' ? 'Professional plan' : 'Organizations plan'} is available.
              No spam, ever.
            </p>
          </form>
        ) : (
          <div className="p-8 text-center">
            ...
            <p className="text-gray-600">
              ...
              {plan === 'professional' ? 'Professional' : 'Organizations'} plan launches.
            </p>
          </div>
        )}
      </div>
