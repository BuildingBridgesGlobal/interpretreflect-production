 ...
 * Main Component
 */
const WellnessCheckInAccessible: React.FC<WellnessCheckInProps> = ({
	onClose,
	onComplete,
}) => {
	const { user } = useAuth();
	...
	const handleSubmit = async () => {
		...
		try {
			...
			console.log(
				"WellnessCheckIn - Skipping growth insights update (uses hanging Supabase client)",
			);
				...
				<div className="space-y-6">
						...
						<div className="grid grid-cols-2 gap-3">
							{[
								...
								<button
									key={reason.value}
									onClick={() =>
										handleFieldChange("check_in_reason", reason.value)
									}
					...
					<div>
						...
						<div className="flex items-center space-x-4">
							<input
								...
								onChange={(e) =>
									handleFieldChange("energyLevel", parseInt(e.target.value))
								}
								className="flex-1"
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("overall_feeling", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("physical_state", e.target.value)
							}
					...
					<div>
						...
						<div className="flex items-center space-x-4">
							<input
								...
								onChange={(e) =>
									handleFieldChange("sleep_quality", parseInt(e.target.value))
								}
								className="flex-1"
								style={{ accentColor: "#5B9378" }}
							/>
					...
					<div>
						...
						<div className="flex items-center space-x-4">
							<input
								...
								onChange={(e) =>
									handleFieldChange("mental_clarity", parseInt(e.target.value))
								}
								className="flex-1"
								style={{ accentColor: "#5B9378" }}
							/>
				...
				<div className="space-y-6">
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("work_satisfaction", e.target.value)
							}
				...
				<div className="space-y-6">
					...
					<div>
						...
						<textarea
							...
							className="w-full px-4 py-3 border rounded-lg resize-none focus:ring-2 focus:ring-sage-500"
							style={{
								borderColor: errors.support_availability
									? "#ef4444"
									: "#E8E5E0",
							}}
						/>
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("immediate_needs", e.target.value)
							}
				...
				<div className="space-y-6">
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("self_care_commitment", e.target.value)
							}
							placeholder="Choose one specific, achievable self-care action..."
							rows={3}
							className="w-full px-4 py-3 border rounded-lg resize-none focus:ring-2 focus:ring-sage-500"
							style={{
								borderColor: errors.self_care_commitment
									? "#ef4444"
									: "#E8E5E0",
							}}
						/>
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("wellness_priority", e.target.value)
							}
					...
					<div>
						...
						<textarea
							...
							onChange={(e) =>
								handleFieldChange("gratitude_note", e.target.value)
							}
