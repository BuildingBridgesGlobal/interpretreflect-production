	...
	headers: {
		contentSecurityPolicy: {
			...
			"connect-src": [
				...
				"https://agenticflow.ai",
			],
			"frame-src": ["https://js.stripe.com", "https://hooks.stripe.com", "https://agenticflow.ai"],
			"font-src": ["'self'", "data:"],
		},
		xFrameOptions: "DENY",
...
export const SECURITY_MESSAGES = {
	...
	privacyConsent:
		"We use encryption and industry best practices to protect your wellness data.",
