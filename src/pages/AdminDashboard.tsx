...
export function AdminDashboard() {
  ...
  const checkAdminAccess = async () => {
    ...
    const adminEmails = ['hello@huviatechnologies.com', 'admin@interpretreflect.com'];
  ...
  const loadMetrics = async () => {
    try {
      ...
      // Calculate metrics
      const totalRevenue = payments?.reduce((sum, p) => sum + (p.amount_paid / 100), 0) || 0;
      ...
      setMetrics({
        ...
        trialUsers: subscriptions?.filter(s => s.status === 'trialing').length || 0,
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <RefreshCw className="w-8 h-8 animate-spin" style={{ color: '#6B8B60' }} />
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              >
                <DollarSign className="w-6 h-6" style={{ color: '#1b5e20' }} />
              </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              >
                <TrendingUp className="w-6 h-6" style={{ color: '#6B8B60' }} />
              </div>
              <span className="text-xs font-semibold" style={{ color: '#10B981' }}>
                +8.3%
              </span>
              ...
              <tbody className="divide-y" style={{ divideColor: '#E5E5E5' }}>
                {recentPayments.map((payment) => (
                  <tr key={payment.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium" style={{ color: '#1A1A1A' }}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span 
                        ...
                        style={{
                          backgroundColor: payment.status === 'succeeded' ? 'rgba(16, 185, 129, 0.1)' : 'rgba(239, 68, 68, 0.1)',
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm" style={{ color: '#666' }}>
