        ...
        >
          <div style={{ marginBottom: '3rem' }}>
            ...
            <p style={{
              ...
              This header component demonstrates WCAG AA compliance with proper color contrast,
              keyboard navigation, screen reader support, and responsive design.
            </p>
          </div>
          ...
          <div style={{
            ...
            <ol style={{
              ...
              <li><strong>Keyboard Navigation:</strong> Press Tab to navigate through all interactive elements</li>
              <li><strong>Skip Link:</strong> Press Tab once to reveal the "Skip to main content" link</li>
              <li><strong>Mobile Menu:</strong> Resize your browser window to see the responsive mobile menu</li>
              <li><strong>Focus States:</strong> Tab through elements to see clear focus indicators</li>
              <li><strong>Screen Reader:</strong> Use NVDA/JAWS/VoiceOver to test announcements</li>
              <li><strong>Color Contrast:</strong> Use browser DevTools or axe to verify contrast ratios</li>
            </ol>
          </div>
          ...
          <div style={{
            ...
            <span style={{
              ...
              Currently: {isAuthenticated ? '✅ Authenticated' : '❌ Not Authenticated'}
            </span>
          </div>
