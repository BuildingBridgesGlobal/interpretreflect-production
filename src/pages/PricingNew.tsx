			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="text-center mb-12">
					...
					<p
						...
						style={{ color: "#4A5568" }}
					>
						Evidence-based tools designed specifically for interpreters to
						prevent burnout, process vicarious trauma, and sustain long-term
						wellness
					</p>
							...
							>
								...
								{isCurrentPlan ? (
									...
									<button
										onClick={() => {
											if (plan.name === "Organizations") {
												window.location.href =
													"mailto:hello@huviatechnologies.com?subject=InterpretReflect Organizations Plan";
										...
										disabled={
											loading === plan.priceId || plan.name === "Professional"
										}
				...
				>
					<p className="text-lg font-semibold" style={{ color: "#2D3748" }}>
