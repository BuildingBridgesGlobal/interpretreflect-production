        ...
        <div key={index} className="flex items-center">
          <div className="relative">
            <div
              ...
              style={{
                backgroundColor: index + 1 < currentStep ? 'rgb(92, 127, 79)' : undefined,
                borderColor: index + 1 === currentStep ? 'rgb(92, 127, 79)' : undefined,
                color: index + 1 === currentStep ? 'rgb(92, 127, 79)' : undefined,
              }}
            >
              {index + 1 < currentStep ? (
            ...
            <span className={`absolute -bottom-6 left-1/2 transform -translate-x-1/2 text-xs whitespace-nowrap ${
              index + 1 === currentStep ? 'text-gray-900 font-semibold' : 'text-gray-500'
            }`}>
              {step}
            </span>
          </div>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <div className="p-4 border rounded-lg focus-within:ring-2 focus-within:border-transparent transition-all"
      ...
      <div className="flex items-center justify-center gap-4 py-4 bg-gray-50 rounded-lg">
        ...
        <div className="flex items-center gap-1 text-sm text-gray-600">
          <Lock className="w-4 h-4" style={{ color: 'rgb(92, 127, 79)' }} />
        ...
        <button
          ...
          style={{
            background: processing
              ? '#ccc'
              : 'linear-gradient(135deg, rgb(92, 127, 79), rgb(107, 142, 94))',
          }}
        >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50">
      ...
      <style>{`
        ...
        input:focus-visible {
          outline-color: rgb(92, 127, 79) !important;
        }
      `}</style>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-2xl mx-auto mt-12">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    style={{ backgroundColor: 'rgb(92, 127, 79)', borderColor: 'rgb(92, 127, 79)' }}
                  >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:border-transparent transition-all ${
                        touched.password && formData.password.length < 6 ? 'border-red-500' : 'border-gray-300'
                      }`}
                      style={{ '--tw-ring-color': 'rgb(92, 127, 79)' } as React.CSSProperties}
                      placeholder="••••••••"
                      required
                    ...
                    <div className="mt-1 text-xs">
                      {formData.password.length > 0 && formData.password.length < 6 ? (
                        ...
                        <p className="text-gray-500">Minimum 6 characters • Avoid common passwords like "password123"</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <button
                  ...
                  style={{
                    background: loading || !formData.email || !formData.password || !formData.name
                      ? '#ccc'
                      : 'linear-gradient(135deg, rgb(92, 127, 79), rgb(107, 142, 94))',
                  }}
                >
                ...
                <div className="space-y-4">
                  ...
                  <div
                    ...
                    className={`border-2 rounded-xl p-6 cursor-pointer transition-all ${
                      formData.plan === 'essential' ? 'bg-green-50' : 'hover:border-gray-300'
                    }`}
                    style={{
                      borderColor: formData.plan === 'essential' ? 'rgb(92, 127, 79)' : undefined,
                    }}
                    role="button"
                    tabIndex={0}
                    onKeyDown={(e) => {
                  ...
                  >
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">Perfect for individual interpreters</p>
                        </div>
                        <div className="text-right">
                          <p className="text-2xl font-bold" style={{ color: 'rgb(92, 127, 79)' }}>
                            $12.99
                          </p>
                ...
                {!user && (
                  <div className="p-4 rounded-lg" style={{
                    ...
                    <p className="text-sm text-white">
                      Setting up your account... If this takes too long, please refresh the page.
                    </p>
                  </div>
                )}
                ...
                <div className="bg-gray-50 rounded-xl p-4 mb-6">
                  ...
                  <div className="border-t pt-2 mt-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-lg" style={{ color: 'rgb(92, 127, 79)' }}>
                        $12.99/month
                      </span>
                    </div>
                  </div>
          ...
          <div className="mt-8 flex justify-center items-center gap-6 text-xs text-gray-500">
            ...
            <div className="flex items-center gap-1">
              <CheckCircle className="w-4 h-4" style={{ color: 'rgb(92, 127, 79)' }} />
