        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-1">Get help and connect with our community</p>
            </div>
          ...
          <section className="bg-white rounded-xl shadow-sm p-8">
            ...
            <div className="space-y-4">
              <details className="border border-gray-200 rounded-lg">
                ...
                <div className="px-6 pb-4">
                  <p className="text-gray-600 mt-2">
                    Click on your profile in the top right corner, then select "Profile Settings".
                    From there, you can update your password under the "Security" section.
                  </p>
                </div>
              </details>
              ...
              <details className="border border-gray-200 rounded-lg">
                <summary className="px-6 py-4 cursor-pointer hover:bg-gray-50 flex items-center">
                  <HelpCircle className="h-5 w-5 text-blue-600 mr-3" />
                  <span className="font-medium text-gray-900">How do I export my wellness data?</span>
                </summary>
                <div className="px-6 pb-4">
                  <p className="text-gray-600 mt-2">
                    Go to the Growth Insights tab and click the download button in the top right corner
                    of the burnout trend chart to export your data as a CSV file.
                  </p>
                </div>
              </details>
              ...
              <details className="border border-gray-200 rounded-lg">
                <summary className="px-6 py-4 cursor-pointer hover:bg-gray-50 flex items-center">
                  <HelpCircle className="h-5 w-5 text-blue-600 mr-3" />
                  <span className="font-medium text-gray-900">What should I do if I'm feeling overwhelmed?</span>
                </summary>
                <div className="px-6 pb-4">
                  <p className="text-gray-600 mt-2">
                    Try one of our quick reset techniques in the Stress Reset tab, or use the Elya AI
                    companion for personalized support. If you need professional help, please consult
          ...
          <section className="bg-white rounded-xl shadow-sm p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-1">For detailed inquiries</p>
              </div>
            </div>
          </section>
