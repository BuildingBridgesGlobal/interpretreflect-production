...
import { STRIPE_PRODUCT, stripePromise } from "../lib/stripe";
	...
	const handleSubscribe = async () => {
		try {
			...
			const response = await fetch(
				`https://kvguxuxanpynwdffpssm.supabase.co/functions/v1/create-checkout-session`,
				{
					method: "POST",
					headers: {
					...
					body: JSON.stringify({
						priceId: STRIPE_PRODUCT.monthly.priceId,
						userId: user.id,
