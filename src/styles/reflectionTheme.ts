...
export const COLORS = {
	...
	accents: {
		...
		green: "#5B9378", // Darker green (WCAG AA with white)
...
export const CATEGORY_THEMES = {
	roleSpace: createCategoryTheme(
		"role_space",
		"Role-Space",
		COLORS.accents.teal,
	),
	neuroscience: createCategoryTheme(
		"neuroscience",
		"Mental Readiness",
		COLORS.accents.purple,
	),
	ethics: createCategoryTheme(
		"ethics",
		"Ethics & Reflection",
		COLORS.accents.yellow,
	),
	emotional: createCategoryTheme(
		"emotional",
		"Emotional Wellness",
		COLORS.accents.coral,
	),
	strategic: createCategoryTheme(
		"strategic",
		"Strategic Planning",
		COLORS.accents.green,
	),
	wellness: createCategoryTheme(
		"wellness",
		"Wellness Check",
		COLORS.accents.blue,
	),
