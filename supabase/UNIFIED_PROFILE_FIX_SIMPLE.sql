-- ============================================
-- UNIFIED PROFILE TABLE FIX (Supabase Compatible)
-- ============================================
-- Simplified version that works in Supabase SQL Editor
...
-- ============================================
-- STEP 2: Merge data from user_profiles (if exists)
-- ============================================

-- Check if user_profiles exists and merge data
...
-- Also try with user_id column (alternative structure)
UPDATE public.profiles p
SET
  full_name = COALESCE(p.full_name, up.full_name),
  pronouns = COALESCE(p.pronouns, up.pronouns),
